...
subtype 'SewrconfDate', as 'DateTime', where { length($_) <= 8 && $_ =~ m{[1-2]{1}[0,9]{1}\d{6}}}, message{ my $length = length($_);my $value = $_; "Value [$value] must be less than [8] char, not [$length] characters.~"  };
...
subtype 'SewrconfDatemod', as 'DateTime', where { length($_) <= 8 && $_ =~ m{[1-2]{1}[0,9]{1}\d{6}}}, message{ my $length = length($_);my $value = $_; "Value [$value] must be less than [8] char, not [$length] characters.~"  };
...
subtype 'SewrconfDatecreate', as 'DateTime', where { length($_) <= 8 && $_ =~ m{[1-2]{1}[0,9]{1}\d{6}}}, message{ my $length = length($_);my $value = $_; "Value [$value] must be less than [8] char, not [$length] characters.~"  };
...
sub create{
  ...
  my $sql_statement ="CREATE TABLE IF NOT EXISTS SEWRCONF ( Usermod TEXT,  Date TEXT,  Vvar2 NUMERIC,  Timemod NUMERIC,  Datemod TEXT,  Errstatus NUMERIC,  Siltdepth NUMERIC,  Colebrook NUMERIC,  Finalvm TEXT,  Catcharea NUMERIC,  Dvar2 NUMERIC,  Vvar1 NUMERIC,  Qvar3 NUMERIC,  Qvar1 NUMERIC,  Vvar3 NUMERIC,  Dvar3 NUMERIC,  Finaldm TEXT,  Dbver12 NUMERIC,  Timecreate NUMERIC,  Time NUMERIC,  Catchpop NUMERIC,  Mannings NUMERIC,  Qvar2 NUMERIC,  Dvar4 NUMERIC,  Finalqm TEXT,  Siltdepthu TEXT,  Station TEXT,  Catchareau TEXT,  Dvar1 NUMERIC,  Colebrooku TEXT,  Datecreate TEXT,  Qvar4 NUMERIC,  Usercreate TEXT,  Vvar4 NUMERIC, PRIMARY KEY ()";
...
sub prepare{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="INSERT INTO SEWRCONF VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
  return $sql_statement;
}
...
Field [siltdepth]false
Field [colebrook]false
Field [finalvm]false
Field [catcharea]false
Field [dvar2]false
Field [vvar1]false
Field [qvar3]false
Field [qvar1]false
...
Field [time]true
Field [catchpop]false
Field [mannings]false
Field [qvar2]false
Field [dvar4]false
Field [finalqm]false
Field [siltdepthu]false
Field [station]true
Field [catchareau]false
Field [dvar1]false
Field [colebrooku]false
...
Field [vvar2] key value [false]
Field [timemod] key value [false]
Field [datemod] key value [false]
Field [errstatus] key value [false]
Field [siltdepth] key value [false]
Field [colebrook] key value [false]
Field [finalvm] key value [false]
Field [catcharea] key value [false]
Field [dvar2] key value [false]
Field [vvar1] key value [false]
Field [qvar3] key value [false]
Field [qvar1] key value [false]
Field [vvar3] key value [false]
Field [dvar3] key value [false]
Field [finaldm] key value [false]
Field [dbver12] key value [false]
Field [timecreate] key value [false]
Field [time] key value [true]
Field [catchpop] key value [false]
Field [mannings] key value [false]
Field [qvar2] key value [false]
Field [dvar4] key value [false]
Field [finalqm] key value [false]
Field [siltdepthu] key value [false]
Field [station] key value [true]
Field [catchareau] key value [false]
Field [dvar1] key value [false]
Field [colebrooku] key value [false]
Field [datecreate] key value [false]
Field [qvar4] key value [false]
Field [usercreate] key value [false]
Field [vvar4] key value [false]
...
sub create{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="CREATE TABLE IF NOT EXISTS SEWRCONF ( Usermod TEXT,  Date TEXT,  Vvar2 NUMERIC,  Timemod NUMERIC,  Datemod TEXT,  Errstatus NUMERIC,  Siltdepth NUMERIC,  Colebrook NUMERIC,  Finalvm TEXT,  Catcharea NUMERIC,  Dvar2 NUMERIC,  Vvar1 NUMERIC,  Qvar3 NUMERIC,  Qvar1 NUMERIC,  Vvar3 NUMERIC,  Dvar3 NUMERIC,  Finaldm TEXT,  Dbver12 NUMERIC,  Timecreate NUMERIC,  Time NUMERIC,  Catchpop NUMERIC,  Mannings NUMERIC,  Qvar2 NUMERIC,  Dvar4 NUMERIC,  Finalqm TEXT,  Siltdepthu TEXT,  Station TEXT,  Catchareau TEXT,  Dvar1 NUMERIC,  Colebrooku TEXT,  Datecreate TEXT,  Qvar4 NUMERIC,  Usercreate TEXT,  Vvar4 NUMERIC, PRIMARY KEY (Date, Time, Station))";
  return $sql_statement;
}
...
sub create{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="CREATE TABLE IF NOT EXISTS SEWRCONF (, PRIMARY KEY ()";
  return $sql_statement;
}

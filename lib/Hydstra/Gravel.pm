...
subtype 'GravelDatemod', as 'DateTime', where { length($_) <= 8 && $_ =~ m{[1-2]{1}[0,9]{1}\d{6}}}, message{ my $length = length($_);my $value = $_; "Value [$value] must be less than [8] char, not [$length] characters.~"  };
...
subtype 'GravelStatusdate', as 'DateTime', where { length($_) <= 8 && $_ =~ m{[1-2]{1}[0,9]{1}\d{6}}}, message{ my $length = length($_);my $value = $_; "Value [$value] must be less than [8] char, not [$length] characters.~"  };
...
subtype 'GravelDatecreate', as 'DateTime', where { length($_) <= 8 && $_ =~ m{[1-2]{1}[0,9]{1}\d{6}}}, message{ my $length = length($_);my $value = $_; "Value [$value] must be less than [8] char, not [$length] characters.~"  };
...
sub create{
  ...
  my $sql_statement ="CREATE TABLE IF NOT EXISTS GRAVEL ( Usermod TEXT,  Revcirc NUMERIC,  Insertmeth TEXT,  Anulgrad TEXT,  Timemod NUMERIC,  Datemod TEXT,  Depthfrom NUMERIC,  Cementused NUMERIC,  Insdiam NUMERIC,  Shovannul NUMERIC,  Rectype TEXT,  Dbver30 NUMERIC,  Statusdate TEXT,  Outdiam NUMERIC,  Spare3 TEXT,  Sizeto NUMERIC,  Type TEXT,  Anuliinter NUMERIC,  Status TEXT,  Timecreate NUMERIC,  Waterused NUMERIC,  Spare2 TEXT,  Sizefrom NUMERIC,  Spare1 TEXT,  Tremiepipe NUMERIC,  Station TEXT,  Quantity NUMERIC,  Depthto NUMERIC,  Party TEXT,  Datecreate TEXT,  Hole NUMERIC,  Usercreate TEXT,  Statustime NUMERIC,  Anultype TEXT, PRIMARY KEY ()";
...
sub prepare{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="INSERT INTO GRAVEL VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
  return $sql_statement;
}
...
Field [usermod]false
Field [revcirc]false
Field [insertmeth]false
Field [anulgrad]false
Field [timemod]false
Field [datemod]false
Field [depthfrom]true
Field [cementused]false
Field [insdiam]false
Field [shovannul]false
Field [rectype]false
Field [dbver30]false
...
Field [sizeto]false
Field [type]false
Field [anuliinter]false
Field [status]false
Field [timecreate]false
Field [waterused]false
Field [spare2]false
Field [sizefrom]false
Field [spare1]false
Field [tremiepipe]false
Field [station]true
...
Field [revcirc] key value [false]
Field [insertmeth] key value [false]
Field [anulgrad] key value [false]
Field [timemod] key value [false]
Field [datemod] key value [false]
Field [depthfrom] key value [true]
Field [cementused] key value [false]
Field [insdiam] key value [false]
Field [shovannul] key value [false]
Field [rectype] key value [false]
Field [dbver30] key value [false]
Field [statusdate] key value [false]
Field [outdiam] key value [false]
Field [spare3] key value [false]
Field [sizeto] key value [false]
Field [type] key value [false]
Field [anuliinter] key value [false]
Field [status] key value [false]
Field [timecreate] key value [false]
Field [waterused] key value [false]
Field [spare2] key value [false]
Field [sizefrom] key value [false]
Field [spare1] key value [false]
Field [tremiepipe] key value [false]
Field [station] key value [true]
Field [quantity] key value [false]
Field [depthto] key value [true]
...
Field [anultype] key value [false]
...
sub create{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="CREATE TABLE IF NOT EXISTS GRAVEL ( Usermod TEXT,  Revcirc NUMERIC,  Insertmeth TEXT,  Anulgrad TEXT,  Timemod NUMERIC,  Datemod TEXT,  Depthfrom NUMERIC,  Cementused NUMERIC,  Insdiam NUMERIC,  Shovannul NUMERIC,  Rectype TEXT,  Dbver30 NUMERIC,  Statusdate TEXT,  Outdiam NUMERIC,  Spare3 TEXT,  Sizeto NUMERIC,  Type TEXT,  Anuliinter NUMERIC,  Status TEXT,  Timecreate NUMERIC,  Waterused NUMERIC,  Spare2 TEXT,  Sizefrom NUMERIC,  Spare1 TEXT,  Tremiepipe NUMERIC,  Station TEXT,  Quantity NUMERIC,  Depthto NUMERIC,  Party TEXT,  Datecreate TEXT,  Hole NUMERIC,  Usercreate TEXT,  Statustime NUMERIC,  Anultype TEXT, PRIMARY KEY (Depthfrom, Station, Depthto, Hole))";
  return $sql_statement;
}
...
sub create{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="CREATE TABLE IF NOT EXISTS GRAVEL (, PRIMARY KEY ()";
  return $sql_statement;
}
...
sub create{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="CREATE TABLE IF NOT EXISTS GRAVEL ( Placeholder ,  Station TEXT,  Hole NUMERIC,  Depthfrom NUMERIC,  Depthto NUMERIC,  Rectype TEXT,  Type TEXT,  Insdiam NUMERIC,  Outdiam NUMERIC,  Anultype TEXT,  Anuliinter NUMERIC,  Anulgrad TEXT,  Sizefrom NUMERIC,  Sizeto NUMERIC,  Quantity NUMERIC,  Waterused NUMERIC,  Cementused NUMERIC,  Insertmeth TEXT,  Shovannul NUMERIC,  Tremiepipe NUMERIC,  Revcirc NUMERIC,  Status TEXT,  Statusdate TEXT,  Statustime NUMERIC,  Party TEXT,  Spare1 TEXT,  Spare2 TEXT,  Spare3 TEXT,  Dbver30 NUMERIC,  Datecreate TEXT,  Timecreate NUMERIC,  Usercreate TEXT,  Datemod TEXT,  Timemod NUMERIC,  Usermod TEXT, PRIMARY KEY (Station, Hole, Depthfrom, Depthto))";
  return $sql_statement;
}

...
sub create{
  ...
  my $sql_statement ="CREATE TABLE IF NOT EXISTS RESULTS ( Variable NUMERIC,  Bottle TEXT,  Usermod TEXT,  Timecreate NUMERIC,  Model TEXT,  Flag TEXT,  Timemod NUMERIC,  Datemod TEXT,  Spare2 TEXT,  Errstatus NUMERIC,  Method TEXT,  Quality NUMERIC,  Spare1 TEXT,  Sampnum TEXT,  Station TEXT,  Make TEXT,  Serial TEXT,  Value NUMERIC,  Uplimit NUMERIC,  Commnt TEXT,  Datecreate TEXT,  Dbver20 NUMERIC,  Usercreate TEXT,  Lolimit NUMERIC,  Accuracy NUMERIC, PRIMARY KEY ()";
...
sub create{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="CREATE TABLE IF NOT EXISTS RESULTS ( Variable NUMERIC,  Bottle TEXT,  Usermod TEXT,  Timecreate NUMERIC,  Model TEXT,  Flag TEXT,  Timemod NUMERIC,  Datemod TEXT,  Spare2 TEXT,  Errstatus NUMERIC,  Method TEXT,  Quality NUMERIC,  Spare1 TEXT,  Sampnum TEXT,  Station TEXT,  Make TEXT,  Serial TEXT,  Value NUMERIC,  Uplimit NUMERIC,  Commnt TEXT,  Datecreate TEXT,  Dbver20 NUMERIC,  Usercreate TEXT,  Lolimit NUMERIC,  Accuracy NUMERIC, PRIMARY KEY (Variable, Bottle, Sampnum, Station))";
  return $sql_statement;
}
...
sub create{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="CREATE TABLE IF NOT EXISTS RESULTS (, PRIMARY KEY ()";
  return $sql_statement;
}
...
sub create{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="CREATE TABLE IF NOT EXISTS RESULTS ( Placeholder ,  Station TEXT,  Sampnum TEXT,  Bottle TEXT,  Variable NUMERIC,  Method TEXT,  Accuracy NUMERIC,  Value NUMERIC,  Flag TEXT,  Quality NUMERIC,  Lolimit NUMERIC,  Uplimit NUMERIC,  Make TEXT,  Model TEXT,  Serial TEXT,  Commnt TEXT,  Spare1 TEXT,  Spare2 TEXT,  Errstatus NUMERIC,  Dbver20 NUMERIC,  Datecreate TEXT,  Timecreate NUMERIC,  Usercreate TEXT,  Datemod TEXT,  Timemod NUMERIC,  Usermod TEXT, PRIMARY KEY (Station, Sampnum, Bottle, Variable))";
  return $sql_statement;
}

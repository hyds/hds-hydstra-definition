...
sub create{
  ...
  my $sql_statement ="CREATE TABLE IF NOT EXISTS SEWRSITE ( Pipelen NUMERIC,  Qfullu TEXT,  Usermod TEXT,  Timecreate NUMERIC,  Wetvf NUMERIC,  Inchmile NUMERIC,  Invslope NUMERIC,  Timemod NUMERIC,  Timebase NUMERIC,  Datemod TEXT,  Rainstn TEXT,  Catchpop NUMERIC,  Xsectid TEXT,  Dbver13 NUMERIC,  Qfull NUMERIC,  Siltdepth NUMERIC,  Catcharea NUMERIC,  Siltdepthu TEXT,  Inchmileu TEXT,  Station TEXT,  Catchareau TEXT,  Conheightu TEXT,  Pipelenu TEXT,  Datecreate TEXT,  Xsectstn TEXT,  Rainvar NUMERIC,  Inflvf NUMERIC,  Conheight NUMERIC,  Usercreate TEXT, PRIMARY KEY ()";
...
Field [wetvf]false
Field [inchmile]false
Field [invslope]false
Field [timemod]false
Field [timebase]false
Field [datemod]false
Field [rainstn]false
...
Field [inchmileu]false
Field [station]true
Field [catchareau]false
Field [conheightu]false
Field [pipelenu]false
Field [datecreate]false
Field [xsectstn]false
Field [rainvar]false
Field [inflvf]false
Field [conheight]false
...
subtype 'SewrsiteUsercreate', as 'Str', where { length($_) <= 8 }, message{ my $length = length($_);my $value = $_; "Value [$value] must be less than [8] char, not [$length] characters.~"  };
 ...
 has 'sewrsite_conheight'  => ( is => 'rw', isa => 'SewrsiteConheight' ); 
 has 'sewrsite_usercreate'  => ( is => 'rw', isa => 'SewrsiteUsercreate' ); 
Field [pipelen] key value [false]
Field [qfullu] key value [false]
Field [usermod] key value [false]
Field [timecreate] key value [false]
Field [wetvf] key value [false]
Field [inchmile] key value [false]
Field [invslope] key value [false]
Field [timemod] key value [false]
Field [timebase] key value [false]
Field [datemod] key value [false]
Field [rainstn] key value [false]
Field [catchpop] key value [false]
Field [xsectid] key value [false]
Field [dbver13] key value [false]
Field [qfull] key value [false]
Field [siltdepth] key value [false]
Field [catcharea] key value [false]
Field [siltdepthu] key value [false]
Field [inchmileu] key value [false]
Field [station] key value [true]
Field [catchareau] key value [false]
Field [conheightu] key value [false]
Field [pipelenu] key value [false]
Field [datecreate] key value [false]
Field [xsectstn] key value [false]
Field [rainvar] key value [false]
Field [inflvf] key value [false]
Field [conheight] key value [false]
...
sub create{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="CREATE TABLE IF NOT EXISTS SEWRSITE ( Pipelen NUMERIC,  Qfullu TEXT,  Usermod TEXT,  Timecreate NUMERIC,  Wetvf NUMERIC,  Inchmile NUMERIC,  Invslope NUMERIC,  Timemod NUMERIC,  Timebase NUMERIC,  Datemod TEXT,  Rainstn TEXT,  Catchpop NUMERIC,  Xsectid TEXT,  Dbver13 NUMERIC,  Qfull NUMERIC,  Siltdepth NUMERIC,  Catcharea NUMERIC,  Siltdepthu TEXT,  Inchmileu TEXT,  Station TEXT,  Catchareau TEXT,  Conheightu TEXT,  Pipelenu TEXT,  Datecreate TEXT,  Xsectstn TEXT,  Rainvar NUMERIC,  Inflvf NUMERIC,  Conheight NUMERIC,  Usercreate TEXT, PRIMARY KEY (Station))";
  return $sql_statement;
}
...
sub create{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="CREATE TABLE IF NOT EXISTS SEWRSITE (, PRIMARY KEY ()";
  return $sql_statement;
}

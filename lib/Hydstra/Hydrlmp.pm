...
sub create{
  ...
  my $sql_statement ="CREATE TABLE IF NOT EXISTS HYDRLMP ( Surveydate TEXT,  Elevacc TEXT,  Usermod TEXT,  Time NUMERIC,  Date TEXT,  Pipe NUMERIC,  Timecreate NUMERIC,  Timemod NUMERIC,  Comments TEXT,  Measpttype TEXT,  Datumtype TEXT,  Datemod TEXT,  Surveyor TEXT,  Measptdesc TEXT,  Spare2 TEXT,  Spare1 TEXT,  Abovgnd NUMERIC,  Station TEXT,  Refpoint NUMERIC,  Datecreate TEXT,  Rlmp NUMERIC,  Spare3 TEXT,  Dbver20 NUMERIC,  Hole NUMERIC,  Usercreate TEXT, PRIMARY KEY ()";
...
Field [measpttype]false
Field [datumtype]false
Field [datemod]false
Field [surveyor]false
Field [measptdesc]false
Field [spare2]false
Field [spare1]false
Field [abovgnd]false
Field [station]true
Field [refpoint]false
...
subtype 'HydrlmpUsercreate', as 'Str', where { length($_) <= 8 }, message{ my $length = length($_);my $value = $_; "Value [$value] must be less than [8] char, not [$length] characters.~"  };
 ...
 has 'hydrlmp_hole'  => ( is => 'rw', isa => 'HydrlmpHole' ); 
 has 'hydrlmp_usercreate'  => ( is => 'rw', isa => 'HydrlmpUsercreate' ); 
Field [surveydate] key value [false]
...
Field [measpttype] key value [false]
Field [datumtype] key value [false]
Field [datemod] key value [false]
Field [surveyor] key value [false]
Field [measptdesc] key value [false]
Field [spare2] key value [false]
Field [spare1] key value [false]
Field [abovgnd] key value [false]
Field [station] key value [true]
Field [refpoint] key value [false]
Field [datecreate] key value [false]
Field [rlmp] key value [false]
...
sub create{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="CREATE TABLE IF NOT EXISTS HYDRLMP ( Surveydate TEXT,  Elevacc TEXT,  Usermod TEXT,  Time NUMERIC,  Date TEXT,  Pipe NUMERIC,  Timecreate NUMERIC,  Timemod NUMERIC,  Comments TEXT,  Measpttype TEXT,  Datumtype TEXT,  Datemod TEXT,  Surveyor TEXT,  Measptdesc TEXT,  Spare2 TEXT,  Spare1 TEXT,  Abovgnd NUMERIC,  Station TEXT,  Refpoint NUMERIC,  Datecreate TEXT,  Rlmp NUMERIC,  Spare3 TEXT,  Dbver20 NUMERIC,  Hole NUMERIC,  Usercreate TEXT, PRIMARY KEY (Time, Date, Pipe, Station, Hole))";
  return $sql_statement;
}
...
sub create{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="CREATE TABLE IF NOT EXISTS HYDRLMP (, PRIMARY KEY ()";
  return $sql_statement;
}

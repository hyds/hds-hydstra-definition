...
subtype 'RateptsDatecreate', as 'DateTime', where { length($_) <= 8 && $_ =~ m{[1-2]{1}[0,9]{1}\d{6}}}, message{ my $length = length($_);my $value = $_; "Value [$value] must be less than [8] char, not [$length] characters.~"  };
...
subtype 'RateptsDatemod', as 'DateTime', where { length($_) <= 8 && $_ =~ m{[1-2]{1}[0,9]{1}\d{6}}}, message{ my $length = length($_);my $value = $_; "Value [$value] must be less than [8] char, not [$length] characters.~"  };
...
sub create{
  ...
  my $sql_statement ="CREATE TABLE IF NOT EXISTS RATEPTS ( Station TEXT,  Stage NUMERIC,  Usermod TEXT,  Timecreate NUMERIC,  Table NUMERIC,  Varfrom NUMERIC,  Dbver14 NUMERIC,  Release NUMERIC,  Datecreate TEXT,  Timemod NUMERIC,  Varto NUMERIC,  Datemod TEXT,  Disch NUMERIC,  Usercreate TEXT,  Rqual NUMERIC, PRIMARY KEY ()";
...
sub prepare{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="INSERT INTO RATEPTS VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
  return $sql_statement;
}
...
sub create{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="CREATE TABLE IF NOT EXISTS RATEPTS ( Station TEXT,  Stage NUMERIC,  Usermod TEXT,  Timecreate NUMERIC,  Table NUMERIC,  Varfrom NUMERIC,  Dbver14 NUMERIC,  Release NUMERIC,  Datecreate TEXT,  Timemod NUMERIC,  Varto NUMERIC,  Datemod TEXT,  Disch NUMERIC,  Usercreate TEXT,  Rqual NUMERIC, PRIMARY KEY (Station, Stage, Table, Varfrom, Release, Varto))";
  return $sql_statement;
}
...
sub create{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="CREATE TABLE IF NOT EXISTS RATEPTS (, PRIMARY KEY ()";
  return $sql_statement;
}

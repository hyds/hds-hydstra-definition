...
sub create{
  ...
  my $sql_statement ="CREATE TABLE IF NOT EXISTS DRILLING ( Width NUMERIC,  Notdrilled NUMERIC,  Usermod TEXT,  Timecreate NUMERIC,  Timemod NUMERIC,  Datemod TEXT,  Dbver23 NUMERIC,  Depthfrom NUMERIC,  Fluid TEXT,  Spare2 TEXT,  Spare1 TEXT,  Station TEXT,  Depthto NUMERIC,  Diameter NUMERIC,  Datecreate TEXT,  Spare3 TEXT,  Hole NUMERIC,  Length NUMERIC,  Usercreate TEXT,  Consmethd TEXT,  Material TEXT, PRIMARY KEY ()";
...
Field [consmethd] key value [false]
Field [material] key value [false]
...
sub create{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="CREATE TABLE IF NOT EXISTS DRILLING ( Width NUMERIC,  Notdrilled NUMERIC,  Usermod TEXT,  Timecreate NUMERIC,  Timemod NUMERIC,  Datemod TEXT,  Dbver23 NUMERIC,  Depthfrom NUMERIC,  Fluid TEXT,  Spare2 TEXT,  Spare1 TEXT,  Station TEXT,  Depthto NUMERIC,  Diameter NUMERIC,  Datecreate TEXT,  Spare3 TEXT,  Hole NUMERIC,  Length NUMERIC,  Usercreate TEXT,  Consmethd TEXT,  Material TEXT, PRIMARY KEY (Depthfrom, Station, Hole))";
  return $sql_statement;
}
...
sub create{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="CREATE TABLE IF NOT EXISTS DRILLING (, PRIMARY KEY ()";
  return $sql_statement;
}

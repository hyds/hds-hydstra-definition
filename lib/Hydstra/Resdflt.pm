...
sub create{
  ...
  my $sql_statement ="CREATE TABLE IF NOT EXISTS RESDFLT ( Usermod TEXT,  Variable NUMERIC,  Timecreate NUMERIC,  Model TEXT,  Flag TEXT,  Timemod NUMERIC,  Datemod TEXT,  Spare2 TEXT,  Method TEXT,  Spare1 TEXT,  Quality NUMERIC,  Make TEXT,  Value NUMERIC,  Serial TEXT,  Uplimit NUMERIC,  Commnt TEXT,  Datecreate TEXT,  Fileformat TEXT,  Usercreate TEXT,  Lolimit NUMERIC,  Accuracy NUMERIC,  Dbver19 NUMERIC, PRIMARY KEY ()";
...
sub prepare{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="INSERT INTO RESDFLT VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
  return $sql_statement;
}
...
Field [make] key value [false]
Field [value] key value [false]
Field [serial] key value [false]
...
sub create{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="CREATE TABLE IF NOT EXISTS RESDFLT ( Usermod TEXT,  Variable NUMERIC,  Timecreate NUMERIC,  Model TEXT,  Flag TEXT,  Timemod NUMERIC,  Datemod TEXT,  Spare2 TEXT,  Method TEXT,  Spare1 TEXT,  Quality NUMERIC,  Make TEXT,  Value NUMERIC,  Serial TEXT,  Uplimit NUMERIC,  Commnt TEXT,  Datecreate TEXT,  Fileformat TEXT,  Usercreate TEXT,  Lolimit NUMERIC,  Accuracy NUMERIC,  Dbver19 NUMERIC, PRIMARY KEY (Variable, Fileformat))";
  return $sql_statement;
}
...
sub create{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="CREATE TABLE IF NOT EXISTS RESDFLT (, PRIMARY KEY ()";
  return $sql_statement;
}
...
sub create{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="CREATE TABLE IF NOT EXISTS RESDFLT ( Placeholder ,  Fileformat TEXT,  Variable NUMERIC,  Method TEXT,  Accuracy NUMERIC,  Value NUMERIC,  Flag TEXT,  Quality NUMERIC,  Lolimit NUMERIC,  Uplimit NUMERIC,  Make TEXT,  Model TEXT,  Serial TEXT,  Commnt TEXT,  Spare1 TEXT,  Spare2 TEXT,  Dbver19 NUMERIC,  Datecreate TEXT,  Timecreate NUMERIC,  Usercreate TEXT,  Datemod TEXT,  Timemod NUMERIC,  Usermod TEXT, PRIMARY KEY (Fileformat, Variable))";
  return $sql_statement;
}

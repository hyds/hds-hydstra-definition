...
sub create{
  ...
  my $sql_statement ="CREATE TABLE IF NOT EXISTS STNINI ( Keyword TEXT,  Station TEXT,  Usermod TEXT,  Timecreate NUMERIC,  Timemod NUMERIC,  Datecreate TEXT,  Descr TEXT,  Datemod TEXT,  Xmldata TEXT,  Dbver20 NUMERIC,  Text TEXT,  Usercreate TEXT,  Order NUMERIC,  Category TEXT, PRIMARY KEY ()";
...
Field [order] key value [true]
Field [category] key value [false]
...
sub create{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="CREATE TABLE IF NOT EXISTS STNINI ( Keyword TEXT,  Station TEXT,  Usermod TEXT,  Timecreate NUMERIC,  Timemod NUMERIC,  Datecreate TEXT,  Descr TEXT,  Datemod TEXT,  Xmldata TEXT,  Dbver20 NUMERIC,  Text TEXT,  Usercreate TEXT,  Order NUMERIC,  Category TEXT, PRIMARY KEY (Keyword, Station, Order))";
  return $sql_statement;
}
...
sub create{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="CREATE TABLE IF NOT EXISTS STNINI (, PRIMARY KEY ()";
  return $sql_statement;
}
...
sub create{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="CREATE TABLE IF NOT EXISTS STNINI ( Placeholder ,  Station TEXT,  Keyword TEXT,  Order NUMERIC,  Category TEXT,  Descr TEXT,  Text TEXT,  Xmldata TEXT,  Dbver20 NUMERIC,  Datecreate TEXT,  Timecreate NUMERIC,  Usercreate TEXT,  Datemod TEXT,  Timemod NUMERIC,  Usermod TEXT, PRIMARY KEY (Station, Keyword, Order))";
  return $sql_statement;
}

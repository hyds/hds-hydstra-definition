...
sub create{
  ...
  my $sql_statement ="CREATE TABLE IF NOT EXISTS SECTHED ( Dbver18 NUMERIC,  Usermod TEXT,  Stype TEXT,  Date TEXT,  Timecreate NUMERIC,  Unitcode TEXT,  Section NUMERIC,  Timemod NUMERIC,  Gaugezero NUMERIC,  Datemod TEXT,  Start_long NUMERIC,  Srun NUMERIC,  Sectno TEXT,  Enteredby TEXT,  Station TEXT,  End_long NUMERIC,  Letter TEXT,  End_lat NUMERIC,  Levelbook TEXT,  Datecreate TEXT,  Checkedby TEXT,  Comment TEXT,  Usercreate TEXT,  Datum TEXT,  Start_lat NUMERIC, PRIMARY KEY ()";
...
Field [unitcode]false
Field [section]false
Field [timemod]false
Field [gaugezero]false
Field [datemod]false
Field [start_long]false
Field [srun]false
Field [sectno]true
Field [enteredby]false
Field [station]true
Field [end_long]false
Field [letter]false
Field [end_lat]false
Field [levelbook]false
Field [datecreate]false
Field [checkedby]false
Field [comment]false
Field [usercreate]false
Field [datum]false
Field [start_lat]false
...
subtype 'SecthedStart_lat', as 'Num', where { length($_) <= 14 && $_ =~ m{[+-]?(\d{1,3})?(\.\d{1,10})?}}, message{ my $length = length($_);my $value = $_; "Value [$value] must be numeric, less than length [14] and decimals [10].~"  };
 ...
 has 'secthed_datum'  => ( is => 'rw', isa => 'SecthedDatum' ); 
 has 'secthed_start_lat'  => ( is => 'rw', isa => 'SecthedStart_lat' ); 
Field [dbver18] key value [false]
Field [usermod] key value [false]
Field [stype] key value [false]
Field [date] key value [false]
Field [timecreate] key value [false]
Field [unitcode] key value [false]
Field [section] key value [false]
Field [timemod] key value [false]
Field [gaugezero] key value [false]
Field [datemod] key value [false]
Field [start_long] key value [false]
Field [srun] key value [false]
Field [sectno] key value [true]
Field [enteredby] key value [false]
Field [station] key value [true]
Field [end_long] key value [false]
Field [letter] key value [false]
Field [end_lat] key value [false]
Field [levelbook] key value [false]
...
Field [datum] key value [false]
Field [start_lat] key value [false]
...
sub create{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="CREATE TABLE IF NOT EXISTS SECTHED ( Dbver18 NUMERIC,  Usermod TEXT,  Stype TEXT,  Date TEXT,  Timecreate NUMERIC,  Unitcode TEXT,  Section NUMERIC,  Timemod NUMERIC,  Gaugezero NUMERIC,  Datemod TEXT,  Start_long NUMERIC,  Srun NUMERIC,  Sectno TEXT,  Enteredby TEXT,  Station TEXT,  End_long NUMERIC,  Letter TEXT,  End_lat NUMERIC,  Levelbook TEXT,  Datecreate TEXT,  Checkedby TEXT,  Comment TEXT,  Usercreate TEXT,  Datum TEXT,  Start_lat NUMERIC, PRIMARY KEY (Sectno, Station))";
  return $sql_statement;
}
...
sub create{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="CREATE TABLE IF NOT EXISTS SECTHED (, PRIMARY KEY ()";
  return $sql_statement;
}
...
sub create{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="CREATE TABLE IF NOT EXISTS SECTHED ( Placeholder ,  Station TEXT,  Sectno TEXT,  Stype TEXT,  Section NUMERIC,  Letter TEXT,  Date TEXT,  Srun NUMERIC,  Enteredby TEXT,  Checkedby TEXT,  Levelbook TEXT,  Comment TEXT,  Gaugezero NUMERIC,  Datum TEXT,  Unitcode TEXT,  Start_lat NUMERIC,  Start_long NUMERIC,  End_lat NUMERIC,  End_long NUMERIC,  Dbver18 NUMERIC,  Datecreate TEXT,  Timecreate NUMERIC,  Usercreate TEXT,  Datemod TEXT,  Timemod NUMERIC,  Usermod TEXT, PRIMARY KEY (Station, Sectno))";
  return $sql_statement;
}

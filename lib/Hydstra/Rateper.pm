...
sub create{
  ...
  my $sql_statement ="CREATE TABLE IF NOT EXISTS RATEPER ( Station TEXT,  Usermod TEXT,  Sdate TEXT,  Timecreate NUMERIC,  Reftab NUMERIC,  Varfrom NUMERIC,  Commnt TEXT,  Refstn TEXT,  Dbver27 NUMERIC,  Timemod NUMERIC,  Varto NUMERIC,  Datecreate TEXT,  Datemod TEXT,  Phase NUMERIC,  Usercreate TEXT,  Stime NUMERIC, PRIMARY KEY ()";
...
Field [phase] key value [false]
Field [usercreate] key value [false]
Field [stime] key value [true]
...
sub create{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="CREATE TABLE IF NOT EXISTS RATEPER ( Station TEXT,  Usermod TEXT,  Sdate TEXT,  Timecreate NUMERIC,  Reftab NUMERIC,  Varfrom NUMERIC,  Commnt TEXT,  Refstn TEXT,  Dbver27 NUMERIC,  Timemod NUMERIC,  Varto NUMERIC,  Datecreate TEXT,  Datemod TEXT,  Phase NUMERIC,  Usercreate TEXT,  Stime NUMERIC, PRIMARY KEY (Station, Sdate, Varfrom, Varto, Stime))";
  return $sql_statement;
}
...
sub create{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="CREATE TABLE IF NOT EXISTS RATEPER (, PRIMARY KEY ()";
  return $sql_statement;
}

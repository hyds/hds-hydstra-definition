...
sub create{
  ...
  my $sql_statement ="CREATE TABLE IF NOT EXISTS SERIES ( Station TEXT,  Stage NUMERIC,  Usermod TEXT,  Date TEXT,  Timecreate NUMERIC,  Time NUMERIC,  Varfrom NUMERIC,  Dbver14 NUMERIC,  Datecreate TEXT,  Timemod NUMERIC,  Varto NUMERIC,  Datemod TEXT,  Disch NUMERIC,  Usercreate TEXT,  Type TEXT, PRIMARY KEY ()";
...
sub create{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="CREATE TABLE IF NOT EXISTS SERIES ( Station TEXT,  Stage NUMERIC,  Usermod TEXT,  Date TEXT,  Timecreate NUMERIC,  Time NUMERIC,  Varfrom NUMERIC,  Dbver14 NUMERIC,  Datecreate TEXT,  Timemod NUMERIC,  Varto NUMERIC,  Datemod TEXT,  Disch NUMERIC,  Usercreate TEXT,  Type TEXT, PRIMARY KEY (Station, Date, Time, Varfrom, Varto, Type))";
  return $sql_statement;
}
...
sub create{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="CREATE TABLE IF NOT EXISTS SERIES (, PRIMARY KEY ()";
  return $sql_statement;
}

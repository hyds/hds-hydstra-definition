...
sub create{
  ...
  my $sql_statement ="CREATE TABLE IF NOT EXISTS SWFPARM ( Edate TEXT,  Dbver6 NUMERIC,  Usermod TEXT,  Variable NUMERIC,  Sdate TEXT,  Timecreate NUMERIC,  Npcomment TEXT,  Timemod NUMERIC,  Datemod TEXT,  Minval NUMERIC,  Scadadev NUMERIC,  Maxval NUMERIC,  Station TEXT,  Mindate TEXT,  Datumcor NUMERIC,  Datecreate TEXT,  Maxdate TEXT,  Parameter TEXT,  Scadastn NUMERIC,  Usercreate TEXT, PRIMARY KEY ()";
...
sub create{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="CREATE TABLE IF NOT EXISTS SWFPARM ( Edate TEXT,  Dbver6 NUMERIC,  Usermod TEXT,  Variable NUMERIC,  Sdate TEXT,  Timecreate NUMERIC,  Npcomment TEXT,  Timemod NUMERIC,  Datemod TEXT,  Minval NUMERIC,  Scadadev NUMERIC,  Maxval NUMERIC,  Station TEXT,  Mindate TEXT,  Datumcor NUMERIC,  Datecreate TEXT,  Maxdate TEXT,  Parameter TEXT,  Scadastn NUMERIC,  Usercreate TEXT, PRIMARY KEY (Station, Parameter))";
  return $sql_statement;
}
...
sub create{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="CREATE TABLE IF NOT EXISTS SWFPARM (, PRIMARY KEY ()";
  return $sql_statement;
}
...
sub create{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="CREATE TABLE IF NOT EXISTS SWFPARM ( Placeholder ,  Station TEXT,  Parameter TEXT,  Variable NUMERIC,  Datumcor NUMERIC,  Npcomment TEXT,  Scadastn NUMERIC,  Scadadev NUMERIC,  Sdate TEXT,  Edate TEXT,  Minval NUMERIC,  Mindate TEXT,  Maxval NUMERIC,  Maxdate TEXT,  Dbver6 NUMERIC,  Datecreate TEXT,  Timecreate NUMERIC,  Usercreate TEXT,  Datemod TEXT,  Timemod NUMERIC,  Usermod TEXT, PRIMARY KEY (Station, Parameter))";
  return $sql_statement;
}

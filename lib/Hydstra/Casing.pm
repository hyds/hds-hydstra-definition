...
subtype 'CasingDatemod', as 'DateTime', where { length($_) <= 8 && $_ =~ m{[1-2]{1}[0,9]{1}\d{6}}}, message{ my $length = length($_);my $value = $_; "Value [$value] must be less than [8] char, not [$length] characters.~"  };
...
subtype 'CasingStatusdate', as 'DateTime', where { length($_) <= 8 && $_ =~ m{[1-2]{1}[0,9]{1}\d{6}}}, message{ my $length = length($_);my $value = $_; "Value [$value] must be less than [8] char, not [$length] characters.~"  };
...
subtype 'CasingDatecreate', as 'DateTime', where { length($_) <= 8 && $_ =~ m{[1-2]{1}[0,9]{1}\d{6}}}, message{ my $length = length($_);my $value = $_; "Value [$value] must be less than [8] char, not [$length] characters.~"  };
...
subtype 'CasingComment', as 'Str', where { length($_) <= 10 }, message{ my $length = length($_);my $value = $_; "Value [$value] must be less than [10] char, not [$length] characters.~"  };
...
sub create{
  ...
  my $sql_statement ="CREATE TABLE IF NOT EXISTS CASING ( Spare5 TEXT,  Slotindiam NUMERIC,  Spare4 TEXT,  Usermod TEXT,  Pipe NUMERIC,  Protectcem NUMERIC,  Timemod NUMERIC,  Datemod TEXT,  Slotoutdia NUMERIC,  Prescemto NUMERIC,  Depthfrom NUMERIC,  Openmeth TEXT,  Cementedto NUMERIC,  Insdiam NUMERIC,  Rectype TEXT,  Filtersock NUMERIC,  Botttype TEXT,  Statusdate TEXT,  Outdiam NUMERIC,  Fixmethod2 TEXT,  Casetype2 TEXT,  Interval NUMERIC,  Spare3 TEXT,  Open NUMERIC,  Scrntype TEXT,  Casetype TEXT,  Centralisr NUMERIC,  Scrndesc TEXT,  Linerdim TEXT,  Sumpfrom NUMERIC,  Notdrilled NUMERIC,  Timecreate NUMERIC,  Status TEXT,  Slotlen NUMERIC,  Openbrand TEXT,  Sumpto NUMERIC,  Cementfrom NUMERIC,  Spare2 TEXT,  Spare1 TEXT,  Attachmeth TEXT,  Station TEXT,  Fixmethod1 TEXT,  Fixmethod4 TEXT,  Depthto NUMERIC,  Datecreate TEXT,  Aperture NUMERIC,  Party TEXT,  Dbver37 NUMERIC,  Hole NUMERIC,  Fixmethod3 TEXT,  Prscemfrom NUMERIC,  Comment TEXT,  Usercreate TEXT,  Statustime NUMERIC,  Openmater TEXT, PRIMARY KEY ()";
...
sub prepare{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="INSERT INTO CASING VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
  return $sql_statement;
}
...
subtype 'CasingOpenmater', as 'Str', where { length($_) <= 8 }, message{ my $length = length($_);my $value = $_; "Value [$value] must be less than [8] char, not [$length] characters.~"  };
 ...
 has 'casing_openmater'  => ( is => 'rw', isa => 'CasingOpenmater' ); 
Field [spare5]false
Field [slotindiam]false
Field [spare4]false
Field [usermod]false
Field [pipe]true
Field [protectcem]false
Field [timemod]false
Field [datemod]false
Field [slotoutdia]false
Field [prescemto]false
Field [depthfrom]true
Field [openmeth]false
Field [cementedto]false
Field [insdiam]false
Field [rectype]false
Field [filtersock]false
Field [botttype]false
Field [statusdate]false
Field [outdiam]true
Field [fixmethod2]false
Field [casetype2]false
Field [interval]false
Field [spare3]false
Field [open]false
Field [scrntype]false
Field [casetype]false
Field [centralisr]false
Field [scrndesc]false
Field [linerdim]false
Field [sumpfrom]false
Field [notdrilled]false
Field [timecreate]false
Field [status]false
Field [slotlen]false
Field [openbrand]false
Field [sumpto]false
Field [cementfrom]false
Field [spare2]false
Field [spare1]false
Field [attachmeth]false
Field [station]true
Field [fixmethod1]false
Field [fixmethod4]false
Field [depthto]false
Field [datecreate]false
Field [aperture]false
Field [party]false
Field [dbver37]false
Field [hole]true
Field [fixmethod3]false
Field [prscemfrom]false
Field [comment]false
Field [usercreate]false
Field [statustime]false
Field [openmater]false
...
Field [slotindiam] key value [false]
Field [spare4] key value [false]
Field [usermod] key value [false]
Field [pipe] key value [true]
Field [protectcem] key value [false]
Field [timemod] key value [false]
Field [datemod] key value [false]
Field [slotoutdia] key value [false]
Field [prescemto] key value [false]
Field [depthfrom] key value [true]
Field [openmeth] key value [false]
Field [cementedto] key value [false]
Field [insdiam] key value [false]
Field [rectype] key value [false]
Field [filtersock] key value [false]
Field [botttype] key value [false]
Field [statusdate] key value [false]
Field [outdiam] key value [true]
Field [fixmethod2] key value [false]
Field [casetype2] key value [false]
Field [interval] key value [false]
Field [spare3] key value [false]
Field [open] key value [false]
Field [scrntype] key value [false]
Field [casetype] key value [false]
Field [centralisr] key value [false]
Field [scrndesc] key value [false]
Field [linerdim] key value [false]
Field [sumpfrom] key value [false]
Field [notdrilled] key value [false]
Field [timecreate] key value [false]
Field [status] key value [false]
Field [slotlen] key value [false]
Field [openbrand] key value [false]
Field [sumpto] key value [false]
Field [cementfrom] key value [false]
Field [spare2] key value [false]
Field [spare1] key value [false]
Field [attachmeth] key value [false]
Field [station] key value [true]
Field [fixmethod1] key value [false]
Field [fixmethod4] key value [false]
Field [depthto] key value [false]
Field [datecreate] key value [false]
Field [aperture] key value [false]
Field [party] key value [false]
Field [dbver37] key value [false]
Field [hole] key value [true]
Field [fixmethod3] key value [false]
Field [prscemfrom] key value [false]
Field [comment] key value [false]
Field [usercreate] key value [false]
Field [statustime] key value [false]
Field [openmater] key value [false]
...
sub create{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="CREATE TABLE IF NOT EXISTS CASING ( Spare5 TEXT,  Slotindiam NUMERIC,  Spare4 TEXT,  Usermod TEXT,  Pipe NUMERIC,  Protectcem NUMERIC,  Timemod NUMERIC,  Datemod TEXT,  Slotoutdia NUMERIC,  Prescemto NUMERIC,  Depthfrom NUMERIC,  Openmeth TEXT,  Cementedto NUMERIC,  Insdiam NUMERIC,  Rectype TEXT,  Filtersock NUMERIC,  Botttype TEXT,  Statusdate TEXT,  Outdiam NUMERIC,  Fixmethod2 TEXT,  Casetype2 TEXT,  Interval NUMERIC,  Spare3 TEXT,  Open NUMERIC,  Scrntype TEXT,  Casetype TEXT,  Centralisr NUMERIC,  Scrndesc TEXT,  Linerdim TEXT,  Sumpfrom NUMERIC,  Notdrilled NUMERIC,  Timecreate NUMERIC,  Status TEXT,  Slotlen NUMERIC,  Openbrand TEXT,  Sumpto NUMERIC,  Cementfrom NUMERIC,  Spare2 TEXT,  Spare1 TEXT,  Attachmeth TEXT,  Station TEXT,  Fixmethod1 TEXT,  Fixmethod4 TEXT,  Depthto NUMERIC,  Datecreate TEXT,  Aperture NUMERIC,  Party TEXT,  Dbver37 NUMERIC,  Hole NUMERIC,  Fixmethod3 TEXT,  Prscemfrom NUMERIC,  Comment TEXT,  Usercreate TEXT,  Statustime NUMERIC,  Openmater TEXT, PRIMARY KEY (Pipe, Depthfrom, Outdiam, Station, Hole))";
  return $sql_statement;
}
...
sub create{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="CREATE TABLE IF NOT EXISTS CASING (, PRIMARY KEY ()";
  return $sql_statement;
}

...
subtype 'SampextrDatemod', as 'DateTime', where { length($_) <= 8 && $_ =~ m{[1-2]{1}[0,9]{1}\d{6}}}, message{ my $length = length($_);my $value = $_; "Value [$value] must be less than [8] char, not [$length] characters.~"  };
...
subtype 'SampextrDatecreate', as 'DateTime', where { length($_) <= 8 && $_ =~ m{[1-2]{1}[0,9]{1}\d{6}}}, message{ my $length = length($_);my $value = $_; "Value [$value] must be less than [8] char, not [$length] characters.~"  };
...
sub create{
  ...
  my $sql_statement ="CREATE TABLE IF NOT EXISTS SAMPEXTR ( Usermod TEXT,  Fixed NUMERIC,  Timecreate NUMERIC,  Position NUMERIC,  Validation TEXT,  Timemod NUMERIC,  Fieldname TEXT,  Datemod TEXT,  Delimiter TEXT,  Template TEXT,  Datecreate TEXT,  Length NUMERIC,  Fileformat TEXT,  Usercreate TEXT,  Numeric NUMERIC,  Invalidact TEXT,  Dbver11 NUMERIC, PRIMARY KEY ()";
...
sub prepare{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="INSERT INTO SAMPEXTR VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
  return $sql_statement;
}
...
Field [template] key value [false]
...
sub create{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="CREATE TABLE IF NOT EXISTS SAMPEXTR ( Usermod TEXT,  Fixed NUMERIC,  Timecreate NUMERIC,  Position NUMERIC,  Validation TEXT,  Timemod NUMERIC,  Fieldname TEXT,  Datemod TEXT,  Delimiter TEXT,  Template TEXT,  Datecreate TEXT,  Length NUMERIC,  Fileformat TEXT,  Usercreate TEXT,  Numeric NUMERIC,  Invalidact TEXT,  Dbver11 NUMERIC, PRIMARY KEY (Fieldname, Fileformat))";
  return $sql_statement;
}
...
sub create{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="CREATE TABLE IF NOT EXISTS SAMPEXTR (, PRIMARY KEY ()";
  return $sql_statement;
}

...
sub create{
  ...
  my $sql_statement ="CREATE TABLE IF NOT EXISTS SECTIONS ( Station TEXT,  Usermod TEXT,  Timecreate NUMERIC,  Commnt TEXT,  Datecreate TEXT,  Timemod NUMERIC,  Datemod TEXT,  Rl NUMERIC,  Dbver20 NUMERIC,  Chain NUMERIC,  Usercreate TEXT,  Order NUMERIC,  Sectno TEXT, PRIMARY KEY ()";
...
Field [rl] key value [false]
Field [dbver20] key value [false]
Field [chain] key value [false]
...
sub create{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="CREATE TABLE IF NOT EXISTS SECTIONS ( Station TEXT,  Usermod TEXT,  Timecreate NUMERIC,  Commnt TEXT,  Datecreate TEXT,  Timemod NUMERIC,  Datemod TEXT,  Rl NUMERIC,  Dbver20 NUMERIC,  Chain NUMERIC,  Usercreate TEXT,  Order NUMERIC,  Sectno TEXT, PRIMARY KEY (Station, Order, Sectno))";
  return $sql_statement;
}
...
sub create{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="CREATE TABLE IF NOT EXISTS SECTIONS (, PRIMARY KEY ()";
  return $sql_statement;
}
...
sub create{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="CREATE TABLE IF NOT EXISTS SECTIONS ( Placeholder ,  Station TEXT,  Sectno TEXT,  Order NUMERIC,  Chain NUMERIC,  Rl NUMERIC,  Commnt TEXT,  Dbver20 NUMERIC,  Datecreate TEXT,  Timecreate NUMERIC,  Usercreate TEXT,  Datemod TEXT,  Timemod NUMERIC,  Usermod TEXT, PRIMARY KEY (Station, Sectno, Order))";
  return $sql_statement;
}

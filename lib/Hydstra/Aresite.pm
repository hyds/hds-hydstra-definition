...
sub create{
  ...
  my $sql_statement ="CREATE TABLE IF NOT EXISTS ARESITE ( Dbver1 NUMERIC,  Lot TEXT,  Tenureblk TEXT,  Usermod TEXT,  Timecreate NUMERIC,  Utilcom TEXT,  Repairdesc TEXT,  Timemod NUMERIC,  Datemod TEXT,  Pumpdate TEXT,  Meterflag NUMERIC,  Tenureno NUMERIC,  Plan TEXT,  Usemtrflag NUMERIC,  Tenuretype TEXT,  Property TEXT,  Gwdbsite NUMERIC,  Station TEXT,  Usevolest NUMERIC,  Gwdbcomm TEXT,  Usecom TEXT,  Usevolmeth TEXT,  Pumpest NUMERIC,  Datecreate TEXT,  Meterdesc TEXT,  Localsite TEXT,  Usevolavg NUMERIC,  Headwdesc TEXT,  Usercreate TEXT, PRIMARY KEY ()";
...
Field [dbver1]false
Field [lot]false
Field [tenureblk]false
Field [usermod]false
Field [timecreate]false
Field [utilcom]false
Field [repairdesc]false
Field [timemod]false
Field [datemod]false
Field [pumpdate]false
Field [meterflag]false
Field [tenureno]false
Field [plan]false
Field [usemtrflag]false
Field [tenuretype]false
Field [property]false
Field [gwdbsite]false
Field [station]true
Field [usevolest]false
Field [gwdbcomm]false
Field [usecom]false
Field [usevolmeth]false
Field [pumpest]false
Field [datecreate]false
Field [meterdesc]false
Field [localsite]false
Field [usevolavg]false
Field [headwdesc]false
...
Field [lot] key value [false]
Field [tenureblk] key value [false]
Field [usermod] key value [false]
Field [timecreate] key value [false]
Field [utilcom] key value [false]
Field [repairdesc] key value [false]
Field [timemod] key value [false]
Field [datemod] key value [false]
Field [pumpdate] key value [false]
Field [meterflag] key value [false]
Field [tenureno] key value [false]
Field [plan] key value [false]
Field [usemtrflag] key value [false]
Field [tenuretype] key value [false]
Field [property] key value [false]
Field [gwdbsite] key value [false]
Field [station] key value [true]
Field [usevolest] key value [false]
Field [gwdbcomm] key value [false]
Field [usecom] key value [false]
Field [usevolmeth] key value [false]
Field [pumpest] key value [false]
Field [datecreate] key value [false]
Field [meterdesc] key value [false]
Field [localsite] key value [false]
Field [usevolavg] key value [false]
Field [headwdesc] key value [false]
...
sub create{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="CREATE TABLE IF NOT EXISTS ARESITE ( Dbver1 NUMERIC,  Lot TEXT,  Tenureblk TEXT,  Usermod TEXT,  Timecreate NUMERIC,  Utilcom TEXT,  Repairdesc TEXT,  Timemod NUMERIC,  Datemod TEXT,  Pumpdate TEXT,  Meterflag NUMERIC,  Tenureno NUMERIC,  Plan TEXT,  Usemtrflag NUMERIC,  Tenuretype TEXT,  Property TEXT,  Gwdbsite NUMERIC,  Station TEXT,  Usevolest NUMERIC,  Gwdbcomm TEXT,  Usecom TEXT,  Usevolmeth TEXT,  Pumpest NUMERIC,  Datecreate TEXT,  Meterdesc TEXT,  Localsite TEXT,  Usevolavg NUMERIC,  Headwdesc TEXT,  Usercreate TEXT, PRIMARY KEY (Station))";
  return $sql_statement;
}
...
sub create{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="CREATE TABLE IF NOT EXISTS ARESITE (, PRIMARY KEY ()";
  return $sql_statement;
}

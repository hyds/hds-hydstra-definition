...
sub create{
  ...
  my $sql_statement ="CREATE TABLE IF NOT EXISTS DRILHIST ( Keyword TEXT,  Usermod TEXT,  Timecreate NUMERIC,  Time NUMERIC,  Drillic TEXT,  Date TEXT,  Timemod NUMERIC,  Datemod TEXT,  Unlicname TEXT,  Dbver3 NUMERIC,  Spare2 TEXT,  Spare1 TEXT,  Datecreate TEXT,  Spare3 TEXT,  Comment TEXT,  Unliccont TEXT,  Usercreate TEXT,  Officer TEXT, PRIMARY KEY ()";
...
Field [unlicname] key value [false]
...
Field [unliccont] key value [false]
Field [usercreate] key value [false]
Field [officer] key value [false]
...
sub create{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="CREATE TABLE IF NOT EXISTS DRILHIST ( Keyword TEXT,  Usermod TEXT,  Timecreate NUMERIC,  Time NUMERIC,  Drillic TEXT,  Date TEXT,  Timemod NUMERIC,  Datemod TEXT,  Unlicname TEXT,  Dbver3 NUMERIC,  Spare2 TEXT,  Spare1 TEXT,  Datecreate TEXT,  Spare3 TEXT,  Comment TEXT,  Unliccont TEXT,  Usercreate TEXT,  Officer TEXT, PRIMARY KEY (Keyword, Time, Drillic, Date))";
  return $sql_statement;
}
...
sub create{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="CREATE TABLE IF NOT EXISTS DRILHIST (, PRIMARY KEY ()";
  return $sql_statement;
}

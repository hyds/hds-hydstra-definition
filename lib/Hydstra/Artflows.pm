...
sub create{
  ...
  my $sql_statement ="CREATE TABLE IF NOT EXISTS ARTFLOWS ( Weirwidth NUMERIC,  Usermod TEXT,  Time NUMERIC,  Date TEXT,  Pipe NUMERIC,  Timecreate NUMERIC,  Dbver5 NUMERIC,  Timemod NUMERIC,  Datemod TEXT,  Velocity NUMERIC,  Backpress NUMERIC,  Spare2 TEXT,  Flowdepth NUMERIC,  Flow NUMERIC,  Spare1 TEXT,  Station TEXT,  Measdevice TEXT,  Datecreate TEXT,  Spare3 TEXT,  Hole NUMERIC,  Temp NUMERIC,  Usercreate TEXT, PRIMARY KEY ()";
...
Field [measdevice] key value [false]
...
sub create{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="CREATE TABLE IF NOT EXISTS ARTFLOWS ( Weirwidth NUMERIC,  Usermod TEXT,  Time NUMERIC,  Date TEXT,  Pipe NUMERIC,  Timecreate NUMERIC,  Dbver5 NUMERIC,  Timemod NUMERIC,  Datemod TEXT,  Velocity NUMERIC,  Backpress NUMERIC,  Spare2 TEXT,  Flowdepth NUMERIC,  Flow NUMERIC,  Spare1 TEXT,  Station TEXT,  Measdevice TEXT,  Datecreate TEXT,  Spare3 TEXT,  Hole NUMERIC,  Temp NUMERIC,  Usercreate TEXT, PRIMARY KEY (Time, Date, Pipe, Station, Hole))";
  return $sql_statement;
}
...
sub create{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="CREATE TABLE IF NOT EXISTS ARTFLOWS (, PRIMARY KEY ()";
  return $sql_statement;
}

...
sub create{
  ...
  my $sql_statement ="CREATE TABLE IF NOT EXISTS TSHIFT ( Station TEXT,  Usermod TEXT,  Sdate TEXT,  Timecreate NUMERIC,  Varfrom NUMERIC,  Active NUMERIC,  Commnt TEXT,  Datecreate TEXT,  Timemod NUMERIC,  Varto NUMERIC,  Datemod TEXT,  Timeshift NUMERIC,  Usercreate TEXT,  Dbver11 NUMERIC,  Stime NUMERIC, PRIMARY KEY ()";
...
Field [timeshift] key value [false]
...
sub create{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="CREATE TABLE IF NOT EXISTS TSHIFT ( Station TEXT,  Usermod TEXT,  Sdate TEXT,  Timecreate NUMERIC,  Varfrom NUMERIC,  Active NUMERIC,  Commnt TEXT,  Datecreate TEXT,  Timemod NUMERIC,  Varto NUMERIC,  Datemod TEXT,  Timeshift NUMERIC,  Usercreate TEXT,  Dbver11 NUMERIC,  Stime NUMERIC, PRIMARY KEY (Station, Sdate, Varfrom, Varto, Stime))";
  return $sql_statement;
}
...
sub create{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="CREATE TABLE IF NOT EXISTS TSHIFT (, PRIMARY KEY ()";
  return $sql_statement;
}

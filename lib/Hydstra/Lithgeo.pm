...
subtype 'LithgeoDate', as 'DateTime', where { length($_) <= 8 && $_ =~ m{[1-2]{1}[0,9]{1}\d{6}}}, message{ my $length = length($_);my $value = $_; "Value [$value] must be less than [8] char, not [$length] characters.~"  };
...
subtype 'LithgeoComments', as 'Str', where { length($_) <= 10 }, message{ my $length = length($_);my $value = $_; "Value [$value] must be less than [10] char, not [$length] characters.~"  };
subtype 'LithgeoDatemod', as 'DateTime', where { length($_) <= 8 && $_ =~ m{[1-2]{1}[0,9]{1}\d{6}}}, message{ my $length = length($_);my $value = $_; "Value [$value] must be less than [8] char, not [$length] characters.~"  };
...
subtype 'LithgeoDatecreate', as 'DateTime', where { length($_) <= 8 && $_ =~ m{[1-2]{1}[0,9]{1}\d{6}}}, message{ my $length = length($_);my $value = $_; "Value [$value] must be less than [8] char, not [$length] characters.~"  };
...
sub create{
  ...
  my $sql_statement ="CREATE TABLE IF NOT EXISTS LITHGEO ( Usermod TEXT,  Date TEXT,  Interpret TEXT,  Timemod NUMERIC,  Rocktype TEXT,  Comments TEXT,  Datemod TEXT,  Dbver25 NUMERIC,  Depthfrom NUMERIC,  Sorting TEXT,  Fracture TEXT,  Porosity TEXT,  Spare3 TEXT,  Coherence TEXT,  Feel TEXT,  Shape TEXT,  Fossils TEXT,  Source TEXT,  Time NUMERIC,  Timecreate NUMERIC,  Color TEXT,  Spare2 TEXT,  Weather TEXT,  Person TEXT,  Verified NUMERIC,  Spare1 TEXT,  Station TEXT,  Depthto NUMERIC,  Rockdesc TEXT,  Datecreate TEXT,  Grainsize TEXT,  Hole NUMERIC,  Structure TEXT,  Usercreate TEXT,  Hardness TEXT, PRIMARY KEY ()";
...
sub prepare{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="INSERT INTO LITHGEO VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
  return $sql_statement;
}
...
Field [sorting]false
Field [fracture]false
Field [porosity]false
Field [spare3]false
Field [coherence]false
Field [feel]false
Field [shape]false
Field [fossils]false
Field [source]false
...
Field [station]true
Field [depthto]false
Field [rockdesc]false
Field [datecreate]false
Field [grainsize]false
Field [hole]true
Field [structure]false
Field [usercreate]false
Field [hardness]false
...
Field [dbver25] key value [false]
Field [depthfrom] key value [true]
Field [sorting] key value [false]
Field [fracture] key value [false]
Field [porosity] key value [false]
Field [spare3] key value [false]
Field [coherence] key value [false]
Field [feel] key value [false]
Field [shape] key value [false]
Field [fossils] key value [false]
Field [source] key value [false]
Field [time] key value [false]
Field [timecreate] key value [false]
Field [color] key value [false]
Field [spare2] key value [false]
Field [weather] key value [false]
...
Field [rockdesc] key value [false]
Field [datecreate] key value [false]
Field [grainsize] key value [false]
Field [hole] key value [true]
Field [structure] key value [false]
Field [usercreate] key value [false]
Field [hardness] key value [false]
...
sub create{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="CREATE TABLE IF NOT EXISTS LITHGEO ( Usermod TEXT,  Date TEXT,  Interpret TEXT,  Timemod NUMERIC,  Rocktype TEXT,  Comments TEXT,  Datemod TEXT,  Dbver25 NUMERIC,  Depthfrom NUMERIC,  Sorting TEXT,  Fracture TEXT,  Porosity TEXT,  Spare3 TEXT,  Coherence TEXT,  Feel TEXT,  Shape TEXT,  Fossils TEXT,  Source TEXT,  Time NUMERIC,  Timecreate NUMERIC,  Color TEXT,  Spare2 TEXT,  Weather TEXT,  Person TEXT,  Verified NUMERIC,  Spare1 TEXT,  Station TEXT,  Depthto NUMERIC,  Rockdesc TEXT,  Datecreate TEXT,  Grainsize TEXT,  Hole NUMERIC,  Structure TEXT,  Usercreate TEXT,  Hardness TEXT, PRIMARY KEY (Interpret, Depthfrom, Station, Hole))";
  return $sql_statement;
}
...
sub create{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="CREATE TABLE IF NOT EXISTS LITHGEO (, PRIMARY KEY ()";
  return $sql_statement;
}

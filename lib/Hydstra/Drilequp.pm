...
sub create{
  ...
  my $sql_statement ="CREATE TABLE IF NOT EXISTS DRILEQUP ( Equipmake TEXT,  Usermod TEXT,  Timecreate NUMERIC,  Drillic TEXT,  Model TEXT,  Timemod NUMERIC,  Capacity TEXT,  Datecreate TEXT,  Datemod TEXT,  Spare3 TEXT,  Dbver3 NUMERIC,  Spare2 TEXT,  Usercreate TEXT,  Type TEXT,  Spare1 TEXT,  Equipment TEXT, PRIMARY KEY ()";
...
subtype 'DrilequpEquipment', as 'Str', where { length($_) <= 8 }, message{ my $length = length($_);my $value = $_; "Value [$value] must be less than [8] char, not [$length] characters.~"  };
 ...
 has 'drilequp_spare1'  => ( is => 'rw', isa => 'DrilequpSpare1' ); 
 has 'drilequp_equipment'  => ( is => 'rw', isa => 'DrilequpEquipment' ); 
Field [equipmake]false
Field [usermod]false
Field [timecreate]false
Field [drillic]true
Field [model]false
Field [timemod]false
Field [capacity]false
...
Field [equipment] key value [true]
...
sub create{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="CREATE TABLE IF NOT EXISTS DRILEQUP ( Equipmake TEXT,  Usermod TEXT,  Timecreate NUMERIC,  Drillic TEXT,  Model TEXT,  Timemod NUMERIC,  Capacity TEXT,  Datecreate TEXT,  Datemod TEXT,  Spare3 TEXT,  Dbver3 NUMERIC,  Spare2 TEXT,  Usercreate TEXT,  Type TEXT,  Spare1 TEXT,  Equipment TEXT, PRIMARY KEY (Drillic, Equipment))";
  return $sql_statement;
}
...
sub create{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="CREATE TABLE IF NOT EXISTS DRILEQUP (, PRIMARY KEY ()";
  return $sql_statement;
}
...
sub create{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="CREATE TABLE IF NOT EXISTS DRILEQUP ( Placeholder ,  Drillic TEXT,  Equipment TEXT,  Equipmake TEXT,  Model TEXT,  Type TEXT,  Capacity TEXT,  Spare1 TEXT,  Spare2 TEXT,  Spare3 TEXT,  Dbver3 NUMERIC,  Datecreate TEXT,  Timecreate NUMERIC,  Usercreate TEXT,  Datemod TEXT,  Timemod NUMERIC,  Usermod TEXT, PRIMARY KEY (Drillic, Equipment))";
  return $sql_statement;
}

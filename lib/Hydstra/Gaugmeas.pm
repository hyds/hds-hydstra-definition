...
sub create{
  ...
  my $sql_statement ="CREATE TABLE IF NOT EXISTS GAUGMEAS ( Variable NUMERIC,  Usermod TEXT,  Timecreate NUMERIC,  Varfrom NUMERIC,  Timemod NUMERIC,  Varto NUMERIC,  Meas_date TEXT,  Datemod TEXT,  Quality NUMERIC,  Station TEXT,  Value NUMERIC,  Start_time NUMERIC,  Datecreate TEXT,  Comment TEXT,  Usercreate TEXT,  Dbver11 NUMERIC, PRIMARY KEY ()";
...
sub prepare{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="INSERT INTO GAUGMEAS VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
  return $sql_statement;
}
...
sub create{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="CREATE TABLE IF NOT EXISTS GAUGMEAS ( Variable NUMERIC,  Usermod TEXT,  Timecreate NUMERIC,  Varfrom NUMERIC,  Timemod NUMERIC,  Varto NUMERIC,  Meas_date TEXT,  Datemod TEXT,  Quality NUMERIC,  Station TEXT,  Value NUMERIC,  Start_time NUMERIC,  Datecreate TEXT,  Comment TEXT,  Usercreate TEXT,  Dbver11 NUMERIC, PRIMARY KEY (Variable, Varfrom, Varto, Meas_date, Station, Start_time))";
  return $sql_statement;
}
...
sub create{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="CREATE TABLE IF NOT EXISTS GAUGMEAS (, PRIMARY KEY ()";
  return $sql_statement;
}

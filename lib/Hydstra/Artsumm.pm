...
sub create{
  ...
  my $sql_statement ="CREATE TABLE IF NOT EXISTS ARTSUMM ( Usermod TEXT,  Date TEXT,  Pipe NUMERIC,  Trickle NUMERIC,  Timemod NUMERIC,  Datemod TEXT,  Flwastage NUMERIC,  Flowdstyp1 TEXT,  Acidalkal NUMERIC,  Basin2 TEXT,  Orifplate NUMERIC,  Eleccond NUMERIC,  Spare3 TEXT,  Basin1 TEXT,  Ctf NUMERIC,  Headleak NUMERIC,  Time NUMERIC,  Timecreate NUMERIC,  Basin3 TEXT,  Flowdstyp4 TEXT,  Barofinish NUMERIC,  Flowdstyp2 TEXT,  Barostart NUMERIC,  Dbver23 NUMERIC,  Loginstall NUMERIC,  Spare2 TEXT,  Spare1 TEXT,  Flowdstyp3 TEXT,  Station TEXT,  Datecreate TEXT,  Note TEXT,  Hole NUMERIC,  Basin4 TEXT,  Openflow NUMERIC,  Monitornam TEXT,  Headwork TEXT,  Watersamp NUMERIC,  Usercreate TEXT,  Lendrain NUMERIC, PRIMARY KEY ()";
...
Field [timemod]false
Field [datemod]false
Field [flwastage]false
Field [flowdstyp1]false
Field [acidalkal]false
Field [basin2]false
Field [orifplate]false
Field [eleccond]false
Field [spare3]false
Field [basin1]false
Field [ctf]false
Field [headleak]false
Field [time]false
Field [timecreate]false
Field [basin3]false
Field [flowdstyp4]false
Field [barofinish]false
Field [flowdstyp2]false
Field [barostart]false
Field [dbver23]false
Field [loginstall]false
Field [spare2]false
Field [spare1]false
Field [flowdstyp3]false
Field [station]true
Field [datecreate]false
Field [note]false
Field [hole]true
Field [basin4]false
Field [openflow]false
Field [monitornam]false
Field [headwork]false
Field [watersamp]false
Field [usercreate]false
Field [lendrain]false
...
Field [trickle] key value [false]
Field [timemod] key value [false]
Field [datemod] key value [false]
Field [flwastage] key value [false]
Field [flowdstyp1] key value [false]
Field [acidalkal] key value [false]
Field [basin2] key value [false]
Field [orifplate] key value [false]
Field [eleccond] key value [false]
Field [spare3] key value [false]
Field [basin1] key value [false]
Field [ctf] key value [false]
Field [headleak] key value [false]
Field [time] key value [false]
Field [timecreate] key value [false]
Field [basin3] key value [false]
Field [flowdstyp4] key value [false]
Field [barofinish] key value [false]
Field [flowdstyp2] key value [false]
Field [barostart] key value [false]
Field [dbver23] key value [false]
Field [loginstall] key value [false]
Field [spare2] key value [false]
Field [spare1] key value [false]
Field [flowdstyp3] key value [false]
Field [station] key value [true]
Field [datecreate] key value [false]
Field [note] key value [false]
Field [hole] key value [true]
Field [basin4] key value [false]
Field [openflow] key value [false]
Field [monitornam] key value [false]
Field [headwork] key value [false]
Field [watersamp] key value [false]
Field [usercreate] key value [false]
Field [lendrain] key value [false]
...
sub create{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="CREATE TABLE IF NOT EXISTS ARTSUMM ( Usermod TEXT,  Date TEXT,  Pipe NUMERIC,  Trickle NUMERIC,  Timemod NUMERIC,  Datemod TEXT,  Flwastage NUMERIC,  Flowdstyp1 TEXT,  Acidalkal NUMERIC,  Basin2 TEXT,  Orifplate NUMERIC,  Eleccond NUMERIC,  Spare3 TEXT,  Basin1 TEXT,  Ctf NUMERIC,  Headleak NUMERIC,  Time NUMERIC,  Timecreate NUMERIC,  Basin3 TEXT,  Flowdstyp4 TEXT,  Barofinish NUMERIC,  Flowdstyp2 TEXT,  Barostart NUMERIC,  Dbver23 NUMERIC,  Loginstall NUMERIC,  Spare2 TEXT,  Spare1 TEXT,  Flowdstyp3 TEXT,  Station TEXT,  Datecreate TEXT,  Note TEXT,  Hole NUMERIC,  Basin4 TEXT,  Openflow NUMERIC,  Monitornam TEXT,  Headwork TEXT,  Watersamp NUMERIC,  Usercreate TEXT,  Lendrain NUMERIC, PRIMARY KEY (Date, Pipe, Station, Hole))";
  return $sql_statement;
}
...
sub create{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="CREATE TABLE IF NOT EXISTS ARTSUMM (, PRIMARY KEY ()";
  return $sql_statement;
}

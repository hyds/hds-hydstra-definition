...
subtype 'PumptestComments', as 'Str', where { length($_) <= 10 }, message{ my $length = length($_);my $value = $_; "Value [$value] must be less than [10] char, not [$length] characters.~"  };
...
subtype 'PumptestDatemod', as 'DateTime', where { length($_) <= 8 && $_ =~ m{[1-2]{1}[0,9]{1}\d{6}}}, message{ my $length = length($_);my $value = $_; "Value [$value] must be less than [8] char, not [$length] characters.~"  };
...
subtype 'PumptestTestdate', as 'DateTime', where { length($_) <= 8 && $_ =~ m{[1-2]{1}[0,9]{1}\d{6}}}, message{ my $length = length($_);my $value = $_; "Value [$value] must be less than [8] char, not [$length] characters.~"  };
...
subtype 'PumptestDatecreate', as 'DateTime', where { length($_) <= 8 && $_ =~ m{[1-2]{1}[0,9]{1}\d{6}}}, message{ my $length = length($_);my $value = $_; "Value [$value] must be less than [8] char, not [$length] characters.~"  };
...
sub create{
  ...
  my $sql_statement ="CREATE TABLE IF NOT EXISTS PUMPTEST ( Usermod TEXT,  Pipe NUMERIC,  Dbver29 NUMERIC,  Comments TEXT,  Yield NUMERIC,  Timemod NUMERIC,  Datemod TEXT,  Transmiss NUMERIC,  Recbywho TEXT,  Starttime NUMERIC,  Ec NUMERIC,  Recdur NUMERIC,  Testtype TEXT,  Depthbefor NUMERIC,  Testdate TEXT,  Duration NUMERIC,  Boredepth NUMERIC,  Spare3 TEXT,  Testedby TEXT,  Rawdatasrc TEXT,  Recpumpset NUMERIC,  Flmeasequp TEXT,  Equipment TEXT,  Depthafter NUMERIC,  Wlmeasequp TEXT,  Timeoftest TEXT,  Swlvalue NUMERIC,  Ddlvalue NUMERIC,  Pumpdepth NUMERIC,  Timecreate NUMERIC,  Coef NUMERIC,  Mpheight NUMERIC,  Mpagl NUMERIC,  Spare2 TEXT,  Sampflag NUMERIC,  Recwl NUMERIC,  Verified NUMERIC,  Meassource TEXT,  Spare1 TEXT,  Station TEXT,  Analysisby TEXT,  Datecreate TEXT,  Hole NUMERIC,  Usercreate TEXT,  Recmaxrate NUMERIC, PRIMARY KEY ()";
...
sub prepare{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="INSERT INTO PUMPTEST VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
  return $sql_statement;
}
...
Field [timemod]false
Field [datemod]false
Field [transmiss]false
Field [recbywho]false
Field [starttime]true
Field [ec]false
Field [recdur]false
Field [testtype]false
Field [depthbefor]false
Field [testdate]true
Field [duration]false
Field [boredepth]false
Field [spare3]false
Field [testedby]false
Field [rawdatasrc]false
Field [recpumpset]false
Field [flmeasequp]false
Field [equipment]false
Field [depthafter]false
Field [wlmeasequp]false
Field [timeoftest]false
Field [swlvalue]false
Field [ddlvalue]false
Field [pumpdepth]false
Field [timecreate]false
Field [coef]false
Field [mpheight]false
Field [mpagl]false
Field [spare2]false
Field [sampflag]false
Field [recwl]false
Field [verified]false
Field [meassource]false
Field [spare1]false
Field [station]true
Field [analysisby]false
Field [datecreate]false
Field [hole]true
Field [usercreate]false
Field [recmaxrate]false
...
Field [transmiss] key value [false]
Field [recbywho] key value [false]
Field [starttime] key value [true]
Field [ec] key value [false]
Field [recdur] key value [false]
Field [testtype] key value [false]
Field [depthbefor] key value [false]
Field [testdate] key value [true]
Field [duration] key value [false]
Field [boredepth] key value [false]
Field [spare3] key value [false]
Field [testedby] key value [false]
Field [rawdatasrc] key value [false]
Field [recpumpset] key value [false]
Field [flmeasequp] key value [false]
Field [equipment] key value [false]
Field [depthafter] key value [false]
Field [wlmeasequp] key value [false]
Field [timeoftest] key value [false]
Field [swlvalue] key value [false]
Field [ddlvalue] key value [false]
Field [pumpdepth] key value [false]
Field [timecreate] key value [false]
Field [coef] key value [false]
Field [mpheight] key value [false]
Field [mpagl] key value [false]
Field [spare2] key value [false]
Field [sampflag] key value [false]
Field [recwl] key value [false]
Field [verified] key value [false]
Field [meassource] key value [false]
Field [spare1] key value [false]
Field [station] key value [true]
Field [analysisby] key value [false]
Field [datecreate] key value [false]
Field [hole] key value [true]
Field [usercreate] key value [false]
Field [recmaxrate] key value [false]
...
sub create{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="CREATE TABLE IF NOT EXISTS PUMPTEST ( Usermod TEXT,  Pipe NUMERIC,  Dbver29 NUMERIC,  Comments TEXT,  Yield NUMERIC,  Timemod NUMERIC,  Datemod TEXT,  Transmiss NUMERIC,  Recbywho TEXT,  Starttime NUMERIC,  Ec NUMERIC,  Recdur NUMERIC,  Testtype TEXT,  Depthbefor NUMERIC,  Testdate TEXT,  Duration NUMERIC,  Boredepth NUMERIC,  Spare3 TEXT,  Testedby TEXT,  Rawdatasrc TEXT,  Recpumpset NUMERIC,  Flmeasequp TEXT,  Equipment TEXT,  Depthafter NUMERIC,  Wlmeasequp TEXT,  Timeoftest TEXT,  Swlvalue NUMERIC,  Ddlvalue NUMERIC,  Pumpdepth NUMERIC,  Timecreate NUMERIC,  Coef NUMERIC,  Mpheight NUMERIC,  Mpagl NUMERIC,  Spare2 TEXT,  Sampflag NUMERIC,  Recwl NUMERIC,  Verified NUMERIC,  Meassource TEXT,  Spare1 TEXT,  Station TEXT,  Analysisby TEXT,  Datecreate TEXT,  Hole NUMERIC,  Usercreate TEXT,  Recmaxrate NUMERIC, PRIMARY KEY (Pipe, Starttime, Testdate, Station, Hole))";
  return $sql_statement;
}
...
sub create{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="CREATE TABLE IF NOT EXISTS PUMPTEST (, PRIMARY KEY ()";
  return $sql_statement;
}

...
sub create{
  ...
  my $sql_statement ="CREATE TABLE IF NOT EXISTS INSTHIST ( Tolucode TEXT,  Datatrans NUMERIC,  Usermod TEXT,  Variable NUMERIC,  Timecreate NUMERIC,  Rangeucode TEXT,  Datein TEXT,  Dbver28 NUMERIC,  Model TEXT,  Timemod NUMERIC,  Elev NUMERIC,  Datemod TEXT,  Text TEXT,  Latitude NUMERIC,  Timein NUMERIC,  Tolerance NUMERIC,  Visitstage TEXT,  Longitude NUMERIC,  Make TEXT,  Station TEXT,  Serial TEXT,  Reason TEXT,  Datecreate TEXT,  Rangelo NUMERIC,  Usercreate TEXT,  Rangehi NUMERIC,  Ipaddress TEXT,  Subnetmask TEXT, PRIMARY KEY ()";
...
subtype 'InsthistSubnetmask', as 'Str', where { length($_) <= 19 }, message{ my $length = length($_);my $value = $_; "Value [$value] must be less than [19] char, not [$length] characters.~"  };
 ...
 has 'insthist_ipaddress'  => ( is => 'rw', isa => 'InsthistIpaddress' ); 
 has 'insthist_subnetmask'  => ( is => 'rw', isa => 'InsthistSubnetmask' ); 
Field [tolucode]false
Field [datatrans]false
Field [usermod]false
Field [variable]false
Field [timecreate]false
Field [rangeucode]false
Field [datein]true
Field [dbver28]false
Field [model]true
Field [timemod]false
...
Field [timein]true
Field [tolerance]false
Field [visitstage]false
...
Field [rangehi]false
Field [ipaddress]false
Field [subnetmask]false
...
subtype 'InsthistSubnetmask', as 'Str', where { length($_) <= 19 }, message{ my $length = length($_);my $value = $_; "Value [$value] must be less than [19] char, not [$length] characters.~"  };
 ...
 has 'insthist_ipaddress'  => ( is => 'rw', isa => 'InsthistIpaddress' ); 
 has 'insthist_subnetmask'  => ( is => 'rw', isa => 'InsthistSubnetmask' ); 
Field [tolucode] key value [false]
Field [datatrans] key value [false]
Field [usermod] key value [false]
Field [variable] key value [false]
Field [timecreate] key value [false]
Field [rangeucode] key value [false]
Field [datein] key value [true]
Field [dbver28] key value [false]
Field [model] key value [true]
Field [timemod] key value [false]
Field [elev] key value [false]
Field [datemod] key value [false]
Field [text] key value [false]
Field [latitude] key value [false]
Field [timein] key value [true]
Field [tolerance] key value [false]
Field [visitstage] key value [false]
Field [longitude] key value [false]
Field [make] key value [true]
Field [station] key value [false]
Field [serial] key value [true]
Field [reason] key value [false]
Field [datecreate] key value [false]
Field [rangelo] key value [false]
Field [usercreate] key value [false]
Field [rangehi] key value [false]
Field [ipaddress] key value [false]
Field [subnetmask] key value [false]
...
sub create{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="CREATE TABLE IF NOT EXISTS INSTHIST ( Tolucode TEXT,  Datatrans NUMERIC,  Usermod TEXT,  Variable NUMERIC,  Timecreate NUMERIC,  Rangeucode TEXT,  Datein TEXT,  Dbver28 NUMERIC,  Model TEXT,  Timemod NUMERIC,  Elev NUMERIC,  Datemod TEXT,  Text TEXT,  Latitude NUMERIC,  Timein NUMERIC,  Tolerance NUMERIC,  Visitstage TEXT,  Longitude NUMERIC,  Make TEXT,  Station TEXT,  Serial TEXT,  Reason TEXT,  Datecreate TEXT,  Rangelo NUMERIC,  Usercreate TEXT,  Rangehi NUMERIC,  Ipaddress TEXT,  Subnetmask TEXT, PRIMARY KEY (Datein, Model, Timein, Make, Serial))";
  return $sql_statement;
}
...
sub create{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="CREATE TABLE IF NOT EXISTS INSTHIST (, PRIMARY KEY ()";
  return $sql_statement;
}

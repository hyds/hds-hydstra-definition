...
sub create{
  ...
  my $sql_statement ="CREATE TABLE IF NOT EXISTS GWTREAT ( Dbver6 NUMERIC,  Usermod TEXT,  Timecreate NUMERIC,  Timemod NUMERIC,  Datemod TEXT,  Treatdate TEXT,  Spare2 TEXT,  Spare1 TEXT,  Success NUMERIC,  Treatmeth TEXT,  Station TEXT,  Treatment2 TEXT,  Quantity NUMERIC,  Duration NUMERIC,  Party TEXT,  Datecreate TEXT,  Treattime NUMERIC,  Spare3 TEXT,  Hole NUMERIC,  Treatment TEXT,  Usercreate TEXT, PRIMARY KEY ()";
...
Field [timemod]false
Field [datemod]false
Field [treatdate]true
Field [spare2]false
Field [spare1]false
Field [success]false
Field [treatmeth]false
Field [station]true
Field [treatment2]false
Field [quantity]false
Field [duration]false
Field [party]false
Field [datecreate]false
Field [treattime]true
Field [spare3]false
Field [hole]true
Field [treatment]true
...
sub create{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="CREATE TABLE IF NOT EXISTS GWTREAT ( Dbver6 NUMERIC,  Usermod TEXT,  Timecreate NUMERIC,  Timemod NUMERIC,  Datemod TEXT,  Treatdate TEXT,  Spare2 TEXT,  Spare1 TEXT,  Success NUMERIC,  Treatmeth TEXT,  Station TEXT,  Treatment2 TEXT,  Quantity NUMERIC,  Duration NUMERIC,  Party TEXT,  Datecreate TEXT,  Treattime NUMERIC,  Spare3 TEXT,  Hole NUMERIC,  Treatment TEXT,  Usercreate TEXT, PRIMARY KEY (Treatdate, Station, Treattime, Hole, Treatment))";
  return $sql_statement;
}
...
sub create{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="CREATE TABLE IF NOT EXISTS GWTREAT (, PRIMARY KEY ()";
  return $sql_statement;
}

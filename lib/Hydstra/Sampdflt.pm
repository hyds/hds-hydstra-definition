...
sub create{
  ...
  my $sql_statement ="CREATE TABLE IF NOT EXISTS SAMPDFLT ( Analtime NUMERIC,  Usermod TEXT,  Date TEXT,  Timemod NUMERIC,  Datemod TEXT,  Numscheme TEXT,  Rectime NUMERIC,  Enteredby TEXT,  Preprocess TEXT,  Inputsrc TEXT,  Collmeth TEXT,  Presmeth4 TEXT,  Name TEXT,  Barcode TEXT,  Commnt TEXT,  Spare3 TEXT,  Labsampref TEXT,  Samptype TEXT,  Labref TEXT,  Presmeth2 TEXT,  Presmeth3 TEXT,  Srcsamp TEXT,  Bottle TEXT,  Collsamp TEXT,  Time NUMERIC,  Timecreate NUMERIC,  Recdate TEXT,  Analdate TEXT,  Project3 TEXT,  Spare2 TEXT,  Spare1 TEXT,  Sampnum TEXT,  Project4 TEXT,  Station TEXT,  Datecreate TEXT,  Dbver20 NUMERIC,  Project2 TEXT,  Presmeth1 TEXT,  Checkedby TEXT,  Fileformat TEXT,  Project1 TEXT,  Usercreate TEXT,  Recvalid TEXT, PRIMARY KEY ()";
...
Field [numscheme] key value [false]
Field [rectime] key value [false]
Field [enteredby] key value [false]
Field [preprocess] key value [false]
...
sub create{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="CREATE TABLE IF NOT EXISTS SAMPDFLT ( Analtime NUMERIC,  Usermod TEXT,  Date TEXT,  Timemod NUMERIC,  Datemod TEXT,  Numscheme TEXT,  Rectime NUMERIC,  Enteredby TEXT,  Preprocess TEXT,  Inputsrc TEXT,  Collmeth TEXT,  Presmeth4 TEXT,  Name TEXT,  Barcode TEXT,  Commnt TEXT,  Spare3 TEXT,  Labsampref TEXT,  Samptype TEXT,  Labref TEXT,  Presmeth2 TEXT,  Presmeth3 TEXT,  Srcsamp TEXT,  Bottle TEXT,  Collsamp TEXT,  Time NUMERIC,  Timecreate NUMERIC,  Recdate TEXT,  Analdate TEXT,  Project3 TEXT,  Spare2 TEXT,  Spare1 TEXT,  Sampnum TEXT,  Project4 TEXT,  Station TEXT,  Datecreate TEXT,  Dbver20 NUMERIC,  Project2 TEXT,  Presmeth1 TEXT,  Checkedby TEXT,  Fileformat TEXT,  Project1 TEXT,  Usercreate TEXT,  Recvalid TEXT, PRIMARY KEY (Fileformat))";
  return $sql_statement;
}
...
sub create{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="CREATE TABLE IF NOT EXISTS SAMPDFLT (, PRIMARY KEY ()";
  return $sql_statement;
}

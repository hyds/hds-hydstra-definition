...
sub create{
  ...
  my $sql_statement ="CREATE TABLE IF NOT EXISTS SSHIFT ( Shift2 NUMERIC,  Usermod TEXT,  Sdate TEXT,  Timecreate NUMERIC,  Shift3 NUMERIC,  Varfrom NUMERIC,  Stage1 NUMERIC,  Timemod NUMERIC,  Varto NUMERIC,  Datemod TEXT,  Stime NUMERIC,  Shift1 NUMERIC,  Stage3 NUMERIC,  Station TEXT,  Stage2 NUMERIC,  Active NUMERIC,  Commnt TEXT,  Datecreate TEXT,  Usercreate TEXT,  Dbver11 NUMERIC, PRIMARY KEY ()";
...
sub prepare{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="INSERT INTO SSHIFT VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
  return $sql_statement;
}
...
sub create{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="CREATE TABLE IF NOT EXISTS SSHIFT (, PRIMARY KEY ()";
  return $sql_statement;
}

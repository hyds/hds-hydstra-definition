...
sub create{
  ...
  my $sql_statement ="CREATE TABLE IF NOT EXISTS DRILSLIC ( Usermod TEXT,  Timecreate NUMERIC,  Drillic TEXT,  Comments TEXT,  Dbver5 NUMERIC,  Timemod NUMERIC,  Statelic TEXT,  Datemod TEXT,  State TEXT,  Spare2 TEXT,  Spare1 TEXT,  Datecreate TEXT,  Spare3 TEXT,  Usercreate TEXT,  Expirydate TEXT,  Class TEXT, PRIMARY KEY ()";
...
sub prepare{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="INSERT INTO DRILSLIC VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
  return $sql_statement;
}
...
Field [dbver5] key value [false]
Field [timemod] key value [false]
Field [statelic] key value [false]
...
sub create{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="CREATE TABLE IF NOT EXISTS DRILSLIC ( Usermod TEXT,  Timecreate NUMERIC,  Drillic TEXT,  Comments TEXT,  Dbver5 NUMERIC,  Timemod NUMERIC,  Statelic TEXT,  Datemod TEXT,  State TEXT,  Spare2 TEXT,  Spare1 TEXT,  Datecreate TEXT,  Spare3 TEXT,  Usercreate TEXT,  Expirydate TEXT,  Class TEXT, PRIMARY KEY (Drillic, State, Class))";
  return $sql_statement;
}
...
sub create{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="CREATE TABLE IF NOT EXISTS DRILSLIC (, PRIMARY KEY ()";
  return $sql_statement;
}
...
sub create{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="CREATE TABLE IF NOT EXISTS DRILSLIC ( Placeholder ,  Drillic TEXT,  State TEXT,  Class TEXT,  Statelic TEXT,  Comments TEXT,  Expirydate TEXT,  Spare1 TEXT,  Spare2 TEXT,  Spare3 TEXT,  Dbver5 NUMERIC,  Datecreate TEXT,  Timecreate NUMERIC,  Usercreate TEXT,  Datemod TEXT,  Timemod NUMERIC,  Usermod TEXT, PRIMARY KEY (Drillic, State, Class))";
  return $sql_statement;
}

...
sub create{
  ...
  my $sql_statement ="CREATE TABLE IF NOT EXISTS RATEHED ( Equations NUMERIC,  Usermod TEXT,  Review TEXT,  Reldate TEXT,  Timecreate NUMERIC,  Table NUMERIC,  Skedinfo TEXT,  Varfrom NUMERIC,  Timemod NUMERIC,  Varto NUMERIC,  Datemod TEXT,  Interp TEXT,  Logoffs NUMERIC,  Station TEXT,  Name TEXT,  Release NUMERIC,  Commnt TEXT,  Datecreate TEXT,  Usercreate TEXT,  Dbver24 NUMERIC, PRIMARY KEY ()";
...
subtype 'RatehedDbver24', as 'Num', where { length($_) <= 1 && $_ =~ m{[+-]?(\d{1,1})?}}, message{ my $length = length($_);my $value = $_; "Value [$value] must be numeric, less than length [1] and decimals [0].~"  };
 ...
 has 'ratehed_usercreate'  => ( is => 'rw', isa => 'RatehedUsercreate' ); 
 has 'ratehed_dbver24'  => ( is => 'rw', isa => 'RatehedDbver24' ); 
Field [equations]false
Field [usermod]false
Field [review]false
Field [reldate]false
Field [timecreate]false
Field [table]true
Field [skedinfo]false
Field [varfrom]true
Field [timemod]false
Field [varto]true
Field [datemod]false
...
subtype 'RatehedDbver24', as 'Num', where { length($_) <= 1 && $_ =~ m{[+-]?(\d{1,1})?}}, message{ my $length = length($_);my $value = $_; "Value [$value] must be numeric, less than length [1] and decimals [0].~"  };
 ...
 has 'ratehed_usercreate'  => ( is => 'rw', isa => 'RatehedUsercreate' ); 
 has 'ratehed_dbver24'  => ( is => 'rw', isa => 'RatehedDbver24' ); 
Field [equations] key value [false]
Field [usermod] key value [false]
Field [review] key value [false]
Field [reldate] key value [false]
Field [timecreate] key value [false]
Field [table] key value [true]
Field [skedinfo] key value [false]
...
sub create{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="CREATE TABLE IF NOT EXISTS RATEHED ( Equations NUMERIC,  Usermod TEXT,  Review TEXT,  Reldate TEXT,  Timecreate NUMERIC,  Table NUMERIC,  Skedinfo TEXT,  Varfrom NUMERIC,  Timemod NUMERIC,  Varto NUMERIC,  Datemod TEXT,  Interp TEXT,  Logoffs NUMERIC,  Station TEXT,  Name TEXT,  Release NUMERIC,  Commnt TEXT,  Datecreate TEXT,  Usercreate TEXT,  Dbver24 NUMERIC, PRIMARY KEY (Table, Varfrom, Varto, Station, Release))";
  return $sql_statement;
}
...
sub create{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="CREATE TABLE IF NOT EXISTS RATEHED (, PRIMARY KEY ()";
  return $sql_statement;
}

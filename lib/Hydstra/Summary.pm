...
sub create{
  ...
  my $sql_statement ="CREATE TABLE IF NOT EXISTS SUMMARY ( Minimum NUMERIC,  Edate TEXT,  Station TEXT,  Maximum NUMERIC,  Count NUMERIC,  Variable NUMERIC,  Sdeviation NUMERIC,  Sdate TEXT,  Dbver8 NUMERIC,  Lo_perc TEXT,  Median TEXT,  Mean NUMERIC,  Hi_perc TEXT, PRIMARY KEY ()";
...
subtype 'SummaryHi_perc', as 'Str', where { length($_) <= 15 }, message{ my $length = length($_);my $value = $_; "Value [$value] must be less than [15] char, not [$length] characters.~"  };
 ...
 has 'summary_mean'  => ( is => 'rw', isa => 'SummaryMean' ); 
 has 'summary_hi_perc'  => ( is => 'rw', isa => 'SummaryHi_perc' ); 
Field [minimum] key value [false]
Field [edate] key value [false]
Field [station] key value [true]
Field [maximum] key value [false]
Field [count] key value [false]
Field [variable] key value [true]
Field [sdeviation] key value [false]
Field [sdate] key value [false]
Field [dbver8] key value [false]
Field [lo_perc] key value [false]
Field [median] key value [false]
Field [mean] key value [false]
Field [hi_perc] key value [false]
...
sub create{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="CREATE TABLE IF NOT EXISTS SUMMARY ( Minimum NUMERIC,  Edate TEXT,  Station TEXT,  Maximum NUMERIC,  Count NUMERIC,  Variable NUMERIC,  Sdeviation NUMERIC,  Sdate TEXT,  Dbver8 NUMERIC,  Lo_perc TEXT,  Median TEXT,  Mean NUMERIC,  Hi_perc TEXT, PRIMARY KEY (Station, Variable))";
  return $sql_statement;
}
...
sub create{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="CREATE TABLE IF NOT EXISTS SUMMARY (, PRIMARY KEY ()";
  return $sql_statement;
}
...
sub create{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="CREATE TABLE IF NOT EXISTS SUMMARY ( Placeholder ,  Station TEXT,  Variable NUMERIC,  Count NUMERIC,  Maximum NUMERIC,  Minimum NUMERIC,  Mean NUMERIC,  Sdeviation NUMERIC,  Lo_perc TEXT,  Median TEXT,  Hi_perc TEXT,  Sdate TEXT,  Edate TEXT,  Dbver8 NUMERIC, PRIMARY KEY (Station, Variable))";
  return $sql_statement;
}

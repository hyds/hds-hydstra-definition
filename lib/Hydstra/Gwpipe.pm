...
subtype 'GwpipeDatemod', as 'DateTime', where { length($_) <= 8 && $_ =~ m{[1-2]{1}[0,9]{1}\d{6}}}, message{ my $length = length($_);my $value = $_; "Value [$value] must be less than [8] char, not [$length] characters.~"  };
...
subtype 'GwpipeDatecreate', as 'DateTime', where { length($_) <= 8 && $_ =~ m{[1-2]{1}[0,9]{1}\d{6}}}, message{ my $length = length($_);my $value = $_; "Value [$value] must be less than [8] char, not [$length] characters.~"  };
...
sub create{
  ...
  my $sql_statement ="CREATE TABLE IF NOT EXISTS GWPIPE ( Toread NUMERIC,  Slotto NUMERIC,  Usermod TEXT,  Pipe NUMERIC,  Timecreate NUMERIC,  Purpose TEXT,  Linkstn TEXT,  Timemod NUMERIC,  Datemod TEXT,  Spare2 TEXT,  Genstatus TEXT,  Bookno TEXT,  Spare1 TEXT,  Parent TEXT,  Station TEXT,  Slotfrom NUMERIC,  Datecreate TEXT,  Spare3 TEXT,  Hole NUMERIC,  Usercreate TEXT,  Dbver4 NUMERIC, PRIMARY KEY ()";
...
sub prepare{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="INSERT INTO GWPIPE VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
  return $sql_statement;
}
...
Field [datemod]false
Field [spare2]false
Field [genstatus]false
Field [bookno]false
Field [spare1]false
Field [parent]false
Field [station]true
Field [slotfrom]false
...
sub create{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="CREATE TABLE IF NOT EXISTS GWPIPE ( Toread NUMERIC,  Slotto NUMERIC,  Usermod TEXT,  Pipe NUMERIC,  Timecreate NUMERIC,  Purpose TEXT,  Linkstn TEXT,  Timemod NUMERIC,  Datemod TEXT,  Spare2 TEXT,  Genstatus TEXT,  Bookno TEXT,  Spare1 TEXT,  Parent TEXT,  Station TEXT,  Slotfrom NUMERIC,  Datecreate TEXT,  Spare3 TEXT,  Hole NUMERIC,  Usercreate TEXT,  Dbver4 NUMERIC, PRIMARY KEY (Pipe, Station, Hole))";
  return $sql_statement;
}
...
sub create{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="CREATE TABLE IF NOT EXISTS GWPIPE (, PRIMARY KEY ()";
  return $sql_statement;
}

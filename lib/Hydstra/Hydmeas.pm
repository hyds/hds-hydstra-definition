...
sub create{
  ...
  my $sql_statement ="CREATE TABLE IF NOT EXISTS HYDMEAS ( Source TEXT,  Usermod TEXT,  Variable NUMERIC,  Time NUMERIC,  Status TEXT,  Date TEXT,  Pipe NUMERIC,  Timecreate NUMERIC,  Meascond3 TEXT,  Flag TEXT,  Timemod NUMERIC,  Datemod TEXT,  Meascond2 TEXT,  Spare2 TEXT,  Meascond1 TEXT,  Quality NUMERIC,  Logger NUMERIC,  Spare1 TEXT,  Station TEXT,  Value NUMERIC,  Dbver21 NUMERIC,  Datecreate TEXT,  Spare3 TEXT,  Measuredby TEXT,  Hole NUMERIC,  Comment TEXT,  Usercreate TEXT, PRIMARY KEY ()";
...
Field [meascond3]false
Field [flag]false
Field [timemod]false
Field [datemod]false
Field [meascond2]false
Field [spare2]false
Field [meascond1]false
Field [quality]false
Field [logger]false
Field [spare1]false
Field [station]true
...
Field [measuredby] key value [false]
...
sub create{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="CREATE TABLE IF NOT EXISTS HYDMEAS ( Source TEXT,  Usermod TEXT,  Variable NUMERIC,  Time NUMERIC,  Status TEXT,  Date TEXT,  Pipe NUMERIC,  Timecreate NUMERIC,  Meascond3 TEXT,  Flag TEXT,  Timemod NUMERIC,  Datemod TEXT,  Meascond2 TEXT,  Spare2 TEXT,  Meascond1 TEXT,  Quality NUMERIC,  Logger NUMERIC,  Spare1 TEXT,  Station TEXT,  Value NUMERIC,  Dbver21 NUMERIC,  Datecreate TEXT,  Spare3 TEXT,  Measuredby TEXT,  Hole NUMERIC,  Comment TEXT,  Usercreate TEXT, PRIMARY KEY (Variable, Time, Date, Pipe, Station, Hole))";
  return $sql_statement;
}
...
sub create{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="CREATE TABLE IF NOT EXISTS HYDMEAS (, PRIMARY KEY ()";
  return $sql_statement;
}

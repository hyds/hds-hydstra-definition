...
sub create{
  ...
  my $sql_statement ="CREATE TABLE IF NOT EXISTS GWDEVEL ( Dbver6 NUMERIC,  Usermod TEXT,  Timecreate NUMERIC,  Timemod NUMERIC,  Chemused NUMERIC,  Datemod TEXT,  Spare2 TEXT,  Verified NUMERIC,  Method TEXT,  Spare1 TEXT,  Station TEXT,  Duration NUMERIC,  Datecreate TEXT,  Details TEXT,  Spare3 TEXT,  Hole NUMERIC,  Usercreate TEXT,  Chemname TEXT, PRIMARY KEY ()";
...
sub create{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="CREATE TABLE IF NOT EXISTS GWDEVEL ( Dbver6 NUMERIC,  Usermod TEXT,  Timecreate NUMERIC,  Timemod NUMERIC,  Chemused NUMERIC,  Datemod TEXT,  Spare2 TEXT,  Verified NUMERIC,  Method TEXT,  Spare1 TEXT,  Station TEXT,  Duration NUMERIC,  Datecreate TEXT,  Details TEXT,  Spare3 TEXT,  Hole NUMERIC,  Usercreate TEXT,  Chemname TEXT, PRIMARY KEY (Method, Station, Hole))";
  return $sql_statement;
}
...
sub create{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="CREATE TABLE IF NOT EXISTS GWDEVEL (, PRIMARY KEY ()";
  return $sql_statement;
}
...
sub create{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="CREATE TABLE IF NOT EXISTS GWDEVEL ( Placeholder ,  Station TEXT,  Hole NUMERIC,  Method TEXT,  Duration NUMERIC,  Details TEXT,  Chemused NUMERIC,  Chemname TEXT,  Verified NUMERIC,  Spare1 TEXT,  Spare2 TEXT,  Spare3 TEXT,  Dbver6 NUMERIC,  Datecreate TEXT,  Timecreate NUMERIC,  Usercreate TEXT,  Datemod TEXT,  Timemod NUMERIC,  Usermod TEXT, PRIMARY KEY (Station, Hole, Method))";
  return $sql_statement;
}

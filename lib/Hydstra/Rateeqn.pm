...
sub create{
  ...
  my $sql_statement ="CREATE TABLE IF NOT EXISTS RATEEQN ( Stagelow NUMERIC,  Usermod TEXT,  Timecreate NUMERIC,  Stagehigh NUMERIC,  Table NUMERIC,  Varfrom NUMERIC,  Equation TEXT,  Timemod NUMERIC,  Varto NUMERIC,  Datemod TEXT,  Rqual NUMERIC,  Station TEXT,  Release NUMERIC,  Datecreate TEXT,  Usercreate TEXT,  Dbver19 NUMERIC, PRIMARY KEY ()";
...
Field [stagehigh]false
Field [table]true
Field [varfrom]true
Field [equation]false
Field [timemod]false
Field [varto]true
Field [datemod]false
Field [rqual]false
...
sub create{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="CREATE TABLE IF NOT EXISTS RATEEQN ( Stagelow NUMERIC,  Usermod TEXT,  Timecreate NUMERIC,  Stagehigh NUMERIC,  Table NUMERIC,  Varfrom NUMERIC,  Equation TEXT,  Timemod NUMERIC,  Varto NUMERIC,  Datemod TEXT,  Rqual NUMERIC,  Station TEXT,  Release NUMERIC,  Datecreate TEXT,  Usercreate TEXT,  Dbver19 NUMERIC, PRIMARY KEY (Stagelow, Table, Varfrom, Varto, Station, Release))";
  return $sql_statement;
}
...
sub create{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="CREATE TABLE IF NOT EXISTS RATEEQN (, PRIMARY KEY ()";
  return $sql_statement;
}

...
subtype 'SectsurvDatecreate', as 'DateTime', where { length($_) <= 8 && $_ =~ m{[1-2]{1}[0,9]{1}\d{6}}}, message{ my $length = length($_);my $value = $_; "Value [$value] must be less than [8] char, not [$length] characters.~"  };
...
subtype 'SectsurvDatemod', as 'DateTime', where { length($_) <= 8 && $_ =~ m{[1-2]{1}[0,9]{1}\d{6}}}, message{ my $length = length($_);my $value = $_; "Value [$value] must be less than [8] char, not [$length] characters.~"  };
...
sub create{
  ...
  my $sql_statement ="CREATE TABLE IF NOT EXISTS SECTSURV ( Station TEXT,  Usermod TEXT,  Instmake TEXT,  Timecreate NUMERIC,  Datecreate TEXT,  Timemod NUMERIC,  By TEXT,  Datemod TEXT,  Dbver13 NUMERIC,  Instmodel TEXT,  Usercreate TEXT,  Type TEXT,  Remarks TEXT,  Sections TEXT,  Year NUMERIC, PRIMARY KEY ()";
...
sub prepare{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="INSERT INTO SECTSURV VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
  return $sql_statement;
}
...
sub create{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="CREATE TABLE IF NOT EXISTS SECTSURV ( Station TEXT,  Usermod TEXT,  Instmake TEXT,  Timecreate NUMERIC,  Datecreate TEXT,  Timemod NUMERIC,  By TEXT,  Datemod TEXT,  Dbver13 NUMERIC,  Instmodel TEXT,  Usercreate TEXT,  Type TEXT,  Remarks TEXT,  Sections TEXT,  Year NUMERIC, PRIMARY KEY (Station, Year))";
  return $sql_statement;
}
...
sub create{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="CREATE TABLE IF NOT EXISTS SECTSURV (, PRIMARY KEY ()";
  return $sql_statement;
}
...
sub create{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="CREATE TABLE IF NOT EXISTS SECTSURV ( Placeholder ,  Station TEXT,  Year NUMERIC,  Sections TEXT,  Type TEXT,  By TEXT,  Instmake TEXT,  Instmodel TEXT,  Remarks TEXT,  Dbver13 NUMERIC,  Datecreate TEXT,  Timecreate NUMERIC,  Usercreate TEXT,  Datemod TEXT,  Timemod NUMERIC,  Usermod TEXT, PRIMARY KEY (Station, Year))";
  return $sql_statement;
}

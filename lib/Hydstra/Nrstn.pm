...
sub create{
  ...
  my $sql_statement ="CREATE TABLE IF NOT EXISTS NRSTN ( Priority NUMERIC,  Station TEXT,  Usermod TEXT,  Timecreate NUMERIC,  Value NUMERIC,  Region TEXT,  Dbver8 NUMERIC,  Timemod NUMERIC,  Subprog TEXT,  Datecreate TEXT,  Activity TEXT,  Program TEXT,  Datemod TEXT,  Usercreate TEXT, PRIMARY KEY ()";
...
sub create{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="CREATE TABLE IF NOT EXISTS NRSTN ( Priority NUMERIC,  Station TEXT,  Usermod TEXT,  Timecreate NUMERIC,  Value NUMERIC,  Region TEXT,  Dbver8 NUMERIC,  Timemod NUMERIC,  Subprog TEXT,  Datecreate TEXT,  Activity TEXT,  Program TEXT,  Datemod TEXT,  Usercreate TEXT, PRIMARY KEY (Station, Region, Subprog, Activity, Program))";
  return $sql_statement;
}
...
sub create{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="CREATE TABLE IF NOT EXISTS NRSTN (, PRIMARY KEY ()";
  return $sql_statement;
}

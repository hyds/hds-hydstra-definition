...
sub create{
  ...
  my $sql_statement ="CREATE TABLE IF NOT EXISTS DRILLIC ( Spare5 TEXT,  Spare4 TEXT,  Usermod TEXT,  Timecreate NUMERIC,  Status TEXT,  Drillic TEXT,  Startdate TEXT,  Comments TEXT,  Timemod NUMERIC,  Datemod TEXT,  Dbver3 NUMERIC,  Spare2 TEXT,  Spare1 TEXT,  Datecreate TEXT,  Spare3 TEXT,  Usercreate TEXT,  Expirydate TEXT,  Class TEXT, PRIMARY KEY ()";
...
sub create{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="CREATE TABLE IF NOT EXISTS DRILLIC ( Spare5 TEXT,  Spare4 TEXT,  Usermod TEXT,  Timecreate NUMERIC,  Status TEXT,  Drillic TEXT,  Startdate TEXT,  Comments TEXT,  Timemod NUMERIC,  Datemod TEXT,  Dbver3 NUMERIC,  Spare2 TEXT,  Spare1 TEXT,  Datecreate TEXT,  Spare3 TEXT,  Usercreate TEXT,  Expirydate TEXT,  Class TEXT, PRIMARY KEY (Drillic, Class))";
  return $sql_statement;
}
...
sub create{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="CREATE TABLE IF NOT EXISTS DRILLIC (, PRIMARY KEY ()";
  return $sql_statement;
}
...
sub create{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="CREATE TABLE IF NOT EXISTS DRILLIC ( Placeholder ,  Drillic TEXT,  Class TEXT,  Status TEXT,  Startdate TEXT,  Expirydate TEXT,  Comments TEXT,  Spare1 TEXT,  Spare2 TEXT,  Spare3 TEXT,  Spare4 TEXT,  Spare5 TEXT,  Dbver3 NUMERIC,  Datecreate TEXT,  Timecreate NUMERIC,  Usercreate TEXT,  Datemod TEXT,  Timemod NUMERIC,  Usermod TEXT, PRIMARY KEY (Drillic, Class))";
  return $sql_statement;
}

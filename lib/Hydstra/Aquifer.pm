...
subtype 'AquiferDatemod', as 'DateTime', where { length($_) <= 8 && $_ =~ m{[1-2]{1}[0,9]{1}\d{6}}}, message{ my $length = length($_);my $value = $_; "Value [$value] must be less than [8] char, not [$length] characters.~"  };
...
subtype 'AquiferDatecreate', as 'DateTime', where { length($_) <= 8 && $_ =~ m{[1-2]{1}[0,9]{1}\d{6}}}, message{ my $length = length($_);my $value = $_; "Value [$value] must be less than [8] char, not [$length] characters.~"  };
...
subtype 'AquiferComment', as 'Str', where { length($_) <= 10 }, message{ my $length = length($_);my $value = $_; "Value [$value] must be less than [10] char, not [$length] characters.~"  };
...
sub create{
  ...
  my $sql_statement ="CREATE TABLE IF NOT EXISTS AQUIFER ( Spare5 TEXT,  Salinvalue NUMERIC,  Usermod TEXT,  Spare4 TEXT,  Ph NUMERIC,  Yield NUMERIC,  Yielddesc TEXT,  Rocktype TEXT,  Timemod NUMERIC,  Datemod TEXT,  Depthfrom NUMERIC,  Name TEXT,  Duration NUMERIC,  Spare3 TEXT,  Swlvalue NUMERIC,  Ddlvalue NUMERIC,  Timecreate NUMERIC,  Dbver27 NUMERIC,  Thickdesc TEXT,  Wbzcat TEXT,  Spare2 TEXT,  Verified NUMERIC,  Spare1 TEXT,  Conduct NUMERIC,  Station TEXT,  Depthto NUMERIC,  Salinity TEXT,  Datecreate TEXT,  Hole NUMERIC,  Comment TEXT,  Equip TEXT,  Usercreate TEXT,  Testdepth NUMERIC,  Yldmeaseq TEXT, PRIMARY KEY ()";
...
sub prepare{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="INSERT INTO AQUIFER VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
  return $sql_statement;
}
...
Field [testdepth]false
Field [yldmeaseq]false
...
Field [salinvalue] key value [false]
...
Field [dbver27] key value [false]
Field [thickdesc] key value [false]
Field [wbzcat] key value [false]
Field [spare2] key value [false]
Field [verified] key value [false]
Field [spare1] key value [false]
Field [conduct] key value [false]
...
Field [equip] key value [false]
Field [usercreate] key value [false]
Field [testdepth] key value [false]
Field [yldmeaseq] key value [false]
...
sub create{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="CREATE TABLE IF NOT EXISTS AQUIFER ( Spare5 TEXT,  Salinvalue NUMERIC,  Usermod TEXT,  Spare4 TEXT,  Ph NUMERIC,  Yield NUMERIC,  Yielddesc TEXT,  Rocktype TEXT,  Timemod NUMERIC,  Datemod TEXT,  Depthfrom NUMERIC,  Name TEXT,  Duration NUMERIC,  Spare3 TEXT,  Swlvalue NUMERIC,  Ddlvalue NUMERIC,  Timecreate NUMERIC,  Dbver27 NUMERIC,  Thickdesc TEXT,  Wbzcat TEXT,  Spare2 TEXT,  Verified NUMERIC,  Spare1 TEXT,  Conduct NUMERIC,  Station TEXT,  Depthto NUMERIC,  Salinity TEXT,  Datecreate TEXT,  Hole NUMERIC,  Comment TEXT,  Equip TEXT,  Usercreate TEXT,  Testdepth NUMERIC,  Yldmeaseq TEXT, PRIMARY KEY (Depthfrom, Station, Hole))";
  return $sql_statement;
}
...
sub create{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="CREATE TABLE IF NOT EXISTS AQUIFER (, PRIMARY KEY ()";
  return $sql_statement;
}
...
sub create{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="CREATE TABLE IF NOT EXISTS AQUIFER ( Placeholder ,  Station TEXT,  Hole NUMERIC,  Depthfrom NUMERIC,  Depthto NUMERIC,  Name TEXT,  Testdepth NUMERIC,  Thickdesc TEXT,  Equip TEXT,  Wbzcat TEXT,  Duration NUMERIC,  Ddlvalue NUMERIC,  Swlvalue NUMERIC,  Yield NUMERIC,  Yielddesc TEXT,  Yldmeaseq TEXT,  Salinvalue NUMERIC,  Salinity TEXT,  Rocktype TEXT,  Conduct NUMERIC,  Ph NUMERIC,  Verified NUMERIC,  Comment TEXT,  Spare1 TEXT,  Spare2 TEXT,  Spare3 TEXT,  Spare4 TEXT,  Spare5 TEXT,  Dbver27 NUMERIC,  Datecreate TEXT,  Timecreate NUMERIC,  Usercreate TEXT,  Datemod TEXT,  Timemod NUMERIC,  Usermod TEXT, PRIMARY KEY (Station, Hole, Depthfrom))";
  return $sql_statement;
}

...
subtype 'ResextrDatemod', as 'DateTime', where { length($_) <= 8 && $_ =~ m{[1-2]{1}[0,9]{1}\d{6}}}, message{ my $length = length($_);my $value = $_; "Value [$value] must be less than [8] char, not [$length] characters.~"  };
...
subtype 'ResextrDatecreate', as 'DateTime', where { length($_) <= 8 && $_ =~ m{[1-2]{1}[0,9]{1}\d{6}}}, message{ my $length = length($_);my $value = $_; "Value [$value] must be less than [8] char, not [$length] characters.~"  };
...
sub create{
  ...
  my $sql_statement ="CREATE TABLE IF NOT EXISTS RESEXTR ( Usermod TEXT,  Add NUMERIC,  Variable NUMERIC,  Timecreate NUMERIC,  Fixed NUMERIC,  Position NUMERIC,  Validation TEXT,  Fieldname TEXT,  Timemod NUMERIC,  Datemod TEXT,  Dbver13 NUMERIC,  Delimiter TEXT,  Datecreate TEXT,  Length NUMERIC,  Fileformat TEXT,  Usercreate TEXT,  Invalidact TEXT,  Numeric NUMERIC,  Mult NUMERIC, PRIMARY KEY ()";
...
sub prepare{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="INSERT INTO RESEXTR VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
  return $sql_statement;
}
...
Field [add] key value [false]
Field [variable] key value [true]
Field [timecreate] key value [false]
Field [fixed] key value [false]
Field [position] key value [false]
Field [validation] key value [false]
Field [fieldname] key value [true]
Field [timemod] key value [false]
Field [datemod] key value [false]
Field [dbver13] key value [false]
Field [delimiter] key value [false]
Field [datecreate] key value [false]
Field [length] key value [false]
Field [fileformat] key value [true]
Field [usercreate] key value [false]
Field [invalidact] key value [false]
Field [numeric] key value [false]
Field [mult] key value [false]
...
sub create{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="CREATE TABLE IF NOT EXISTS RESEXTR ( Usermod TEXT,  Add NUMERIC,  Variable NUMERIC,  Timecreate NUMERIC,  Fixed NUMERIC,  Position NUMERIC,  Validation TEXT,  Fieldname TEXT,  Timemod NUMERIC,  Datemod TEXT,  Dbver13 NUMERIC,  Delimiter TEXT,  Datecreate TEXT,  Length NUMERIC,  Fileformat TEXT,  Usercreate TEXT,  Invalidact TEXT,  Numeric NUMERIC,  Mult NUMERIC, PRIMARY KEY (Variable, Fieldname, Fileformat))";
  return $sql_statement;
}
...
sub create{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="CREATE TABLE IF NOT EXISTS RESEXTR (, PRIMARY KEY ()";
  return $sql_statement;
}

...
subtype 'TtabptsDate', as 'DateTime', where { length($_) <= 8 && $_ =~ m{[1-2]{1}[0,9]{1}\d{6}}}, message{ my $length = length($_);my $value = $_; "Value [$value] must be less than [8] char, not [$length] characters.~"  };
...
subtype 'TtabptsDatecreate', as 'DateTime', where { length($_) <= 8 && $_ =~ m{[1-2]{1}[0,9]{1}\d{6}}}, message{ my $length = length($_);my $value = $_; "Value [$value] must be less than [8] char, not [$length] characters.~"  };
subtype 'TtabptsDatemod', as 'DateTime', where { length($_) <= 8 && $_ =~ m{[1-2]{1}[0,9]{1}\d{6}}}, message{ my $length = length($_);my $value = $_; "Value [$value] must be less than [8] char, not [$length] characters.~"  };
subtype 'TtabptsComment', as 'Str', where { length($_) <= 10 }, message{ my $length = length($_);my $value = $_; "Value [$value] must be less than [10] char, not [$length] characters.~"  };
...
sub create{
  ...
  my $sql_statement ="CREATE TABLE IF NOT EXISTS TTABPTS ( Station TEXT,  Usermod TEXT,  Variable NUMERIC,  Value NUMERIC,  Timecreate NUMERIC,  Time NUMERIC,  Date TEXT,  Dbver14 NUMERIC,  Timemod NUMERIC,  Datecreate TEXT,  Datemod TEXT,  Comment TEXT,  Usercreate TEXT,  Quality NUMERIC, PRIMARY KEY ()";
...
sub prepare{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="INSERT INTO TTABPTS VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
  return $sql_statement;
}
...
sub create{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="CREATE TABLE IF NOT EXISTS TTABPTS ( Station TEXT,  Usermod TEXT,  Variable NUMERIC,  Value NUMERIC,  Timecreate NUMERIC,  Time NUMERIC,  Date TEXT,  Dbver14 NUMERIC,  Timemod NUMERIC,  Datecreate TEXT,  Datemod TEXT,  Comment TEXT,  Usercreate TEXT,  Quality NUMERIC, PRIMARY KEY (Station, Variable, Time, Date))";
  return $sql_statement;
}
...
sub create{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="CREATE TABLE IF NOT EXISTS TTABPTS (, PRIMARY KEY ()";
  return $sql_statement;
}
...
sub create{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="CREATE TABLE IF NOT EXISTS TTABPTS ( Placeholder ,  Station TEXT,  Variable NUMERIC,  Date TEXT,  Time NUMERIC,  Value NUMERIC,  Quality NUMERIC,  Comment TEXT,  Dbver14 NUMERIC,  Datecreate TEXT,  Timecreate NUMERIC,  Usercreate TEXT,  Datemod TEXT,  Timemod NUMERIC,  Usermod TEXT, PRIMARY KEY (Station, Variable, Date, Time))";
  return $sql_statement;
}

...
sub create{
  ...
  my $sql_statement ="CREATE TABLE IF NOT EXISTS PEAKTIME ( Edate TEXT,  Usermod TEXT,  Peaktype TEXT,  Timecreate NUMERIC,  Sdate TEXT,  Varfrom NUMERIC,  Varto NUMERIC,  Timemod NUMERIC,  Datemod TEXT,  Rtime NUMERIC,  Qmin NUMERIC,  Stime NUMERIC,  Station TEXT,  Tmin NUMERIC,  Dbver14 NUMERIC,  Datecreate TEXT,  Etime NUMERIC,  Usercreate TEXT,  Rdate TEXT, PRIMARY KEY ()";
...
sub create{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="CREATE TABLE IF NOT EXISTS PEAKTIME ( Edate TEXT,  Usermod TEXT,  Peaktype TEXT,  Timecreate NUMERIC,  Sdate TEXT,  Varfrom NUMERIC,  Varto NUMERIC,  Timemod NUMERIC,  Datemod TEXT,  Rtime NUMERIC,  Qmin NUMERIC,  Stime NUMERIC,  Station TEXT,  Tmin NUMERIC,  Dbver14 NUMERIC,  Datecreate TEXT,  Etime NUMERIC,  Usercreate TEXT,  Rdate TEXT, PRIMARY KEY (Peaktype, Varfrom, Varto, Station))";
  return $sql_statement;
}
...
sub create{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="CREATE TABLE IF NOT EXISTS PEAKTIME (, PRIMARY KEY ()";
  return $sql_statement;
}

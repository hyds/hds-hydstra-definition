...
subtype 'ArtdistDate', as 'DateTime', where { length($_) <= 8 && $_ =~ m{[1-2]{1}[0,9]{1}\d{6}}}, message{ my $length = length($_);my $value = $_; "Value [$value] must be less than [8] char, not [$length] characters.~"  };
...
subtype 'ArtdistDatemod', as 'DateTime', where { length($_) <= 8 && $_ =~ m{[1-2]{1}[0,9]{1}\d{6}}}, message{ my $length = length($_);my $value = $_; "Value [$value] must be less than [8] char, not [$length] characters.~"  };
...
subtype 'ArtdistDatecreate', as 'DateTime', where { length($_) <= 8 && $_ =~ m{[1-2]{1}[0,9]{1}\d{6}}}, message{ my $length = length($_);my $value = $_; "Value [$value] must be less than [8] char, not [$length] characters.~"  };
...
sub create{
  ...
  my $sql_statement ="CREATE TABLE IF NOT EXISTS ARTDIST ( Usermod TEXT,  Weirwidth NUMERIC,  Time NUMERIC,  Date TEXT,  Timecreate NUMERIC,  Pipe NUMERIC,  Dbver8 NUMERIC,  Timemod NUMERIC,  Datemod TEXT,  Velocity NUMERIC,  Backpress NUMERIC,  Spare2 TEXT,  Flowdepth NUMERIC,  Flow NUMERIC,  Pointid NUMERIC,  Onarrival TEXT,  Spare1 TEXT,  Station TEXT,  Measdevice TEXT,  Datecreate TEXT,  Spare3 TEXT,  Hole NUMERIC,  Usercreate TEXT,  Pointname TEXT, PRIMARY KEY ()";
...
sub prepare{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="INSERT INTO ARTDIST VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
  return $sql_statement;
}
...
Field [backpress]false
Field [spare2]false
Field [flowdepth]false
Field [flow]false
Field [pointid]true
Field [onarrival]true
Field [spare1]false
Field [station]true
Field [measdevice]true
Field [datecreate]false
Field [spare3]false
Field [hole]true
Field [usercreate]false
Field [pointname]false
...
Field [weirwidth] key value [false]
...
sub create{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="CREATE TABLE IF NOT EXISTS ARTDIST ( Usermod TEXT,  Weirwidth NUMERIC,  Time NUMERIC,  Date TEXT,  Timecreate NUMERIC,  Pipe NUMERIC,  Dbver8 NUMERIC,  Timemod NUMERIC,  Datemod TEXT,  Velocity NUMERIC,  Backpress NUMERIC,  Spare2 TEXT,  Flowdepth NUMERIC,  Flow NUMERIC,  Pointid NUMERIC,  Onarrival TEXT,  Spare1 TEXT,  Station TEXT,  Measdevice TEXT,  Datecreate TEXT,  Spare3 TEXT,  Hole NUMERIC,  Usercreate TEXT,  Pointname TEXT, PRIMARY KEY (Time, Date, Pipe, Pointid, Onarrival, Station, Measdevice, Hole))";
  return $sql_statement;
}
...
sub create{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="CREATE TABLE IF NOT EXISTS ARTDIST (, PRIMARY KEY ()";
  return $sql_statement;
}

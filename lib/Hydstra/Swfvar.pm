...
subtype 'SwfvarDatemod', as 'DateTime', where { length($_) <= 8 && $_ =~ m{[1-2]{1}[0,9]{1}\d{6}}}, message{ my $length = length($_);my $value = $_; "Value [$value] must be less than [8] char, not [$length] characters.~"  };
...
subtype 'SwfvarStatdate', as 'DateTime', where { length($_) <= 8 && $_ =~ m{[1-2]{1}[0,9]{1}\d{6}}}, message{ my $length = length($_);my $value = $_; "Value [$value] must be less than [8] char, not [$length] characters.~"  };
...
subtype 'SwfvarDatecreate', as 'DateTime', where { length($_) <= 8 && $_ =~ m{[1-2]{1}[0,9]{1}\d{6}}}, message{ my $length = length($_);my $value = $_; "Value [$value] must be less than [8] char, not [$length] characters.~"  };
...
sub create{
  ...
  my $sql_statement ="CREATE TABLE IF NOT EXISTS SWFVAR ( Spare5 TEXT,  Highthresh NUMERIC,  Spare4 TEXT,  Variable NUMERIC,  Usermod TEXT,  Timecreate NUMERIC,  Lowthresh NUMERIC,  Timemod NUMERIC,  Datemod TEXT,  Spare9 TEXT,  Statdate TEXT,  Spare2 TEXT,  Spare10 TEXT,  Spare1 TEXT,  Stattime NUMERIC,  Station TEXT,  Parmaxover NUMERIC,  Spare6 TEXT,  Spare7 TEXT,  Instrument TEXT,  Datecreate TEXT,  Spare3 TEXT,  Usercreate TEXT,  Spare8 TEXT,  Parminover NUMERIC,  Dbver4 NUMERIC, PRIMARY KEY ()";
...
sub prepare{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="INSERT INTO SWFVAR VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
  return $sql_statement;
}
...
subtype 'SwfvarDbver4', as 'Num', where { length($_) <= 1 && $_ =~ m{[+-]?(\d{1,1})?}}, message{ my $length = length($_);my $value = $_; "Value [$value] must be numeric, less than length [1] and decimals [0].~"  };
 ...
 has 'swfvar_dbver4'  => ( is => 'rw', isa => 'SwfvarDbver4' ); 
Field [spare5]false
Field [highthresh]false
Field [spare4]false
Field [variable]true
Field [usermod]false
Field [timecreate]false
Field [lowthresh]false
Field [timemod]false
Field [datemod]false
Field [spare9]false
Field [statdate]true
...
Field [parmaxover] key value [false]
...
Field [parminover] key value [false]
...
sub create{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="CREATE TABLE IF NOT EXISTS SWFVAR ( Spare5 TEXT,  Highthresh NUMERIC,  Spare4 TEXT,  Variable NUMERIC,  Usermod TEXT,  Timecreate NUMERIC,  Lowthresh NUMERIC,  Timemod NUMERIC,  Datemod TEXT,  Spare9 TEXT,  Statdate TEXT,  Spare2 TEXT,  Spare10 TEXT,  Spare1 TEXT,  Stattime NUMERIC,  Station TEXT,  Parmaxover NUMERIC,  Spare6 TEXT,  Spare7 TEXT,  Instrument TEXT,  Datecreate TEXT,  Spare3 TEXT,  Usercreate TEXT,  Spare8 TEXT,  Parminover NUMERIC,  Dbver4 NUMERIC, PRIMARY KEY (Variable, Statdate, Stattime, Station))";
  return $sql_statement;
}
...
sub create{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="CREATE TABLE IF NOT EXISTS SWFVAR (, PRIMARY KEY ()";
  return $sql_statement;
}
...
sub create{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="CREATE TABLE IF NOT EXISTS SWFVAR ( Placeholder ,  Station TEXT,  Variable NUMERIC,  Statdate TEXT,  Stattime NUMERIC,  Highthresh NUMERIC,  Instrument TEXT,  Lowthresh NUMERIC,  Parmaxover NUMERIC,  Parminover NUMERIC,  Spare1 TEXT,  Spare2 TEXT,  Spare3 TEXT,  Spare4 TEXT,  Spare5 TEXT,  Spare6 TEXT,  Spare7 TEXT,  Spare8 TEXT,  Spare9 TEXT,  Spare10 TEXT,  Dbver4 NUMERIC,  Datecreate TEXT,  Timecreate NUMERIC,  Usercreate TEXT,  Datemod TEXT,  Timemod NUMERIC,  Usermod TEXT, PRIMARY KEY (Station, Variable, Statdate, Stattime))";
  return $sql_statement;
}

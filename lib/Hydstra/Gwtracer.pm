...
subtype 'GwtracerDate', as 'DateTime', where { length($_) <= 8 && $_ =~ m{[1-2]{1}[0,9]{1}\d{6}}}, message{ my $length = length($_);my $value = $_; "Value [$value] must be less than [8] char, not [$length] characters.~"  };
...
subtype 'GwtracerDatemod', as 'DateTime', where { length($_) <= 8 && $_ =~ m{[1-2]{1}[0,9]{1}\d{6}}}, message{ my $length = length($_);my $value = $_; "Value [$value] must be less than [8] char, not [$length] characters.~"  };
...
subtype 'GwtracerDatecreate', as 'DateTime', where { length($_) <= 8 && $_ =~ m{[1-2]{1}[0,9]{1}\d{6}}}, message{ my $length = length($_);my $value = $_; "Value [$value] must be less than [8] char, not [$length] characters.~"  };
...
sub create{
  ...
  my $sql_statement ="CREATE TABLE IF NOT EXISTS GWTRACER ( Variable NUMERIC,  Usermod TEXT,  Time NUMERIC,  Date TEXT,  Timecreate NUMERIC,  Pipe NUMERIC,  Timemod NUMERIC,  Datemod TEXT,  Dbver3 NUMERIC,  Quality NUMERIC,  Station TEXT,  Value NUMERIC,  Datecreate TEXT,  Depth NUMERIC,  Hole NUMERIC,  Usercreate TEXT, PRIMARY KEY ()";
...
sub prepare{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="INSERT INTO GWTRACER VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
  return $sql_statement;
}
...
sub create{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="CREATE TABLE IF NOT EXISTS GWTRACER ( Variable NUMERIC,  Usermod TEXT,  Time NUMERIC,  Date TEXT,  Timecreate NUMERIC,  Pipe NUMERIC,  Timemod NUMERIC,  Datemod TEXT,  Dbver3 NUMERIC,  Quality NUMERIC,  Station TEXT,  Value NUMERIC,  Datecreate TEXT,  Depth NUMERIC,  Hole NUMERIC,  Usercreate TEXT, PRIMARY KEY (Variable, Time, Date, Pipe, Station, Depth, Hole))";
  return $sql_statement;
}
...
sub create{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="CREATE TABLE IF NOT EXISTS GWTRACER (, PRIMARY KEY ()";
  return $sql_statement;
}

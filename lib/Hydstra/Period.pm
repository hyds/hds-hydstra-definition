...
subtype 'PeriodPerend', as 'DateTime', where { length($_) <= 8 && $_ =~ m{[1-2]{1}[0,9]{1}\d{6}}}, message{ my $length = length($_);my $value = $_; "Value [$value] must be less than [8] char, not [$length] characters.~"  };
subtype 'PeriodDatemod', as 'DateTime', where { length($_) <= 8 && $_ =~ m{[1-2]{1}[0,9]{1}\d{6}}}, message{ my $length = length($_);my $value = $_; "Value [$value] must be less than [8] char, not [$length] characters.~"  };
subtype 'PeriodPerstart', as 'DateTime', where { length($_) <= 8 && $_ =~ m{[1-2]{1}[0,9]{1}\d{6}}}, message{ my $length = length($_);my $value = $_; "Value [$value] must be less than [8] char, not [$length] characters.~"  };
subtype 'PeriodPcentiles', as 'Str', where { length($_) <= 10 }, message{ my $length = length($_);my $value = $_; "Value [$value] must be less than [10] char, not [$length] characters.~"  };
...
subtype 'PeriodRundate', as 'DateTime', where { length($_) <= 8 && $_ =~ m{[1-2]{1}[0,9]{1}\d{6}}}, message{ my $length = length($_);my $value = $_; "Value [$value] must be less than [8] char, not [$length] characters.~"  };
...
subtype 'PeriodMindate', as 'DateTime', where { length($_) <= 8 && $_ =~ m{[1-2]{1}[0,9]{1}\d{6}}}, message{ my $length = length($_);my $value = $_; "Value [$value] must be less than [8] char, not [$length] characters.~"  };
...
subtype 'PeriodDatecreate', as 'DateTime', where { length($_) <= 8 && $_ =~ m{[1-2]{1}[0,9]{1}\d{6}}}, message{ my $length = length($_);my $value = $_; "Value [$value] must be less than [8] char, not [$length] characters.~"  };
...
subtype 'PeriodMaxdate', as 'DateTime', where { length($_) <= 8 && $_ =~ m{[1-2]{1}[0,9]{1}\d{6}}}, message{ my $length = length($_);my $value = $_; "Value [$value] must be less than [8] char, not [$length] characters.~"  };
...
sub create{
  ...
  my $sql_statement ="CREATE TABLE IF NOT EXISTS PERIOD ( Subdesc TEXT,  Variable NUMERIC,  Usermod TEXT,  Timecreate NUMERIC,  Numdays NUMERIC,  Varfrom NUMERIC,  Timemod NUMERIC,  Perend TEXT,  Datemod TEXT,  Perstart TEXT,  Pcentiles TEXT,  Minvalue NUMERIC,  Reportmin NUMERIC,  Rundate TEXT,  Station TEXT,  Mindate TEXT,  Dbver21 NUMERIC,  Maxvalue NUMERIC,  Datecreate TEXT,  Datasource TEXT,  Mintime NUMERIC,  Maxdate TEXT,  Runtime NUMERIC,  Usercreate TEXT,  Maxtime NUMERIC,  Datatype TEXT, PRIMARY KEY ()";
...
sub prepare{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="INSERT INTO PERIOD VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
  return $sql_statement;
}
...
Field [perend]false
Field [datemod]false
Field [perstart]false
Field [pcentiles]false
Field [minvalue]false
Field [reportmin]false
Field [rundate]false
Field [station]true
Field [mindate]false
Field [dbver21]false
Field [maxvalue]false
Field [datecreate]false
Field [datasource]true
Field [mintime]false
Field [maxdate]false
Field [runtime]false
...
subtype 'PeriodDatatype', as 'Str', where { length($_) <= 8 }, message{ my $length = length($_);my $value = $_; "Value [$value] must be less than [8] char, not [$length] characters.~"  };
 ...
 has 'period_maxtime'  => ( is => 'rw', isa => 'PeriodMaxtime' ); 
 has 'period_datatype'  => ( is => 'rw', isa => 'PeriodDatatype' ); 
Field [subdesc] key value [false]
Field [variable] key value [true]
Field [usermod] key value [false]
Field [timecreate] key value [false]
Field [numdays] key value [false]
Field [varfrom] key value [true]
Field [timemod] key value [false]
Field [perend] key value [false]
Field [datemod] key value [false]
Field [perstart] key value [false]
Field [pcentiles] key value [false]
Field [minvalue] key value [false]
Field [reportmin] key value [false]
Field [rundate] key value [false]
Field [station] key value [true]
Field [mindate] key value [false]
Field [dbver21] key value [false]
Field [maxvalue] key value [false]
Field [datecreate] key value [false]
Field [datasource] key value [true]
Field [mintime] key value [false]
Field [maxdate] key value [false]
Field [runtime] key value [false]
Field [usercreate] key value [false]
Field [maxtime] key value [false]
Field [datatype] key value [false]
...
sub create{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="CREATE TABLE IF NOT EXISTS PERIOD ( Subdesc TEXT,  Variable NUMERIC,  Usermod TEXT,  Timecreate NUMERIC,  Numdays NUMERIC,  Varfrom NUMERIC,  Timemod NUMERIC,  Perend TEXT,  Datemod TEXT,  Perstart TEXT,  Pcentiles TEXT,  Minvalue NUMERIC,  Reportmin NUMERIC,  Rundate TEXT,  Station TEXT,  Mindate TEXT,  Dbver21 NUMERIC,  Maxvalue NUMERIC,  Datecreate TEXT,  Datasource TEXT,  Mintime NUMERIC,  Maxdate TEXT,  Runtime NUMERIC,  Usercreate TEXT,  Maxtime NUMERIC,  Datatype TEXT, PRIMARY KEY (Variable, Varfrom, Station, Datasource))";
  return $sql_statement;
}
...
sub create{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="CREATE TABLE IF NOT EXISTS PERIOD (, PRIMARY KEY ()";
  return $sql_statement;
}

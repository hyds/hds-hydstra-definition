...
subtype 'SiteDatemod', as 'DateTime', where { length($_) <= 8 && $_ =~ m{[1-2]{1}[0,9]{1}\d{6}}}, message{ my $length = length($_);my $value = $_; "Value [$value] must be less than [8] char, not [$length] characters.~"  };
...
subtype 'SiteCommence', as 'DateTime', where { length($_) <= 8 && $_ =~ m{[1-2]{1}[0,9]{1}\d{6}}}, message{ my $length = length($_);my $value = $_; "Value [$value] must be less than [8] char, not [$length] characters.~"  };
...
subtype 'SiteCease', as 'DateTime', where { length($_) <= 8 && $_ =~ m{[1-2]{1}[0,9]{1}\d{6}}}, message{ my $length = length($_);my $value = $_; "Value [$value] must be less than [8] char, not [$length] characters.~"  };
...
subtype 'SiteDatecreate', as 'DateTime', where { length($_) <= 8 && $_ =~ m{[1-2]{1}[0,9]{1}\d{6}}}, message{ my $length = length($_);my $value = $_; "Value [$value] must be less than [8] char, not [$length] characters.~"  };
...
subtype 'SiteComment', as 'Str', where { length($_) <= 10 }, message{ my $length = length($_);my $value = $_; "Value [$value] must be less than [10] char, not [$length] characters.~"  };
...
sub create{
  ...
  my $sql_statement ="CREATE TABLE IF NOT EXISTS SITE ( Usermod TEXT,  Stname TEXT,  Mapname TEXT,  Timemod NUMERIC,  Datemod TEXT,  Category11 TEXT,  Category13 TEXT,  Category2 TEXT,  Latitude NUMERIC,  Enteredby TEXT,  Orgcode TEXT,  Dbver38 NUMERIC,  Category9 TEXT,  Longitude NUMERIC,  Parent TEXT,  Posacc TEXT,  Timezone NUMERIC,  Category7 TEXT,  Region TEXT,  Active NUMERIC,  Local_map TEXT,  Category8 TEXT,  Barcode TEXT,  Category6 TEXT,  Category14 TEXT,  Category3 TEXT,  Meridian TEXT,  Shortname TEXT,  Elevacc TEXT,  Category4 TEXT,  Timecreate NUMERIC,  Category10 TEXT,  Zone NUMERIC,  Quarter TEXT,  Category5 TEXT,  Range TEXT,  Section NUMERIC,  Stntype TEXT,  Elev NUMERIC,  Grdatum TEXT,  Spare2 TEXT,  Category15 TEXT,  Northing NUMERIC,  Commence TEXT,  Lldatum TEXT,  Cease TEXT,  Spare1 TEXT,  Easting NUMERIC,  Owner TEXT,  Station TEXT,  Township TEXT,  Category1 TEXT,  Datecreate TEXT,  Category12 TEXT,  Checkedby TEXT,  Comment TEXT,  Usercreate TEXT,  Qquarter TEXT, PRIMARY KEY ()";
...
sub prepare{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="INSERT INTO SITE VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
  return $sql_statement;
}
...
Field [timemod]false
Field [datemod]false
Field [category11]false
Field [category13]false
Field [category2]false
Field [latitude]false
Field [enteredby]false
Field [orgcode]false
Field [dbver38]false
Field [category9]false
Field [longitude]false
Field [parent]false
Field [posacc]false
Field [timezone]false
Field [category7]false
Field [region]false
Field [active]false
Field [local_map]false
Field [category8]false
Field [barcode]false
Field [category6]false
Field [category14]false
Field [category3]false
Field [meridian]false
Field [shortname]false
Field [elevacc]false
Field [category4]false
Field [timecreate]false
Field [category10]false
Field [zone]false
Field [quarter]false
Field [category5]false
Field [range]false
Field [section]false
Field [stntype]false
Field [elev]false
Field [grdatum]false
Field [spare2]false
Field [category15]false
Field [northing]false
Field [commence]false
Field [lldatum]false
Field [cease]false
Field [spare1]false
Field [easting]false
Field [owner]false
Field [station]true
Field [township]false
Field [category1]false
Field [datecreate]false
Field [category12]false
Field [checkedby]false
Field [comment]false
Field [usercreate]false
Field [qquarter]false
...
Field [stname] key value [false]
Field [mapname] key value [false]
Field [timemod] key value [false]
Field [datemod] key value [false]
Field [category11] key value [false]
Field [category13] key value [false]
Field [category2] key value [false]
Field [latitude] key value [false]
Field [enteredby] key value [false]
Field [orgcode] key value [false]
Field [dbver38] key value [false]
Field [category9] key value [false]
Field [longitude] key value [false]
Field [parent] key value [false]
Field [posacc] key value [false]
Field [timezone] key value [false]
Field [category7] key value [false]
Field [region] key value [false]
Field [active] key value [false]
Field [local_map] key value [false]
Field [category8] key value [false]
Field [barcode] key value [false]
Field [category6] key value [false]
Field [category14] key value [false]
Field [category3] key value [false]
Field [meridian] key value [false]
Field [shortname] key value [false]
Field [elevacc] key value [false]
Field [category4] key value [false]
Field [timecreate] key value [false]
Field [category10] key value [false]
Field [zone] key value [false]
Field [quarter] key value [false]
Field [category5] key value [false]
Field [range] key value [false]
Field [section] key value [false]
Field [stntype] key value [false]
Field [elev] key value [false]
Field [grdatum] key value [false]
Field [spare2] key value [false]
Field [category15] key value [false]
Field [northing] key value [false]
Field [commence] key value [false]
Field [lldatum] key value [false]
Field [cease] key value [false]
Field [spare1] key value [false]
Field [easting] key value [false]
Field [owner] key value [false]
Field [station] key value [true]
Field [township] key value [false]
Field [category1] key value [false]
Field [datecreate] key value [false]
Field [category12] key value [false]
Field [checkedby] key value [false]
Field [comment] key value [false]
Field [usercreate] key value [false]
Field [qquarter] key value [false]
...
sub create{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="CREATE TABLE IF NOT EXISTS SITE ( Usermod TEXT,  Stname TEXT,  Mapname TEXT,  Timemod NUMERIC,  Datemod TEXT,  Category11 TEXT,  Category13 TEXT,  Category2 TEXT,  Latitude NUMERIC,  Enteredby TEXT,  Orgcode TEXT,  Dbver38 NUMERIC,  Category9 TEXT,  Longitude NUMERIC,  Parent TEXT,  Posacc TEXT,  Timezone NUMERIC,  Category7 TEXT,  Region TEXT,  Active NUMERIC,  Local_map TEXT,  Category8 TEXT,  Barcode TEXT,  Category6 TEXT,  Category14 TEXT,  Category3 TEXT,  Meridian TEXT,  Shortname TEXT,  Elevacc TEXT,  Category4 TEXT,  Timecreate NUMERIC,  Category10 TEXT,  Zone NUMERIC,  Quarter TEXT,  Category5 TEXT,  Range TEXT,  Section NUMERIC,  Stntype TEXT,  Elev NUMERIC,  Grdatum TEXT,  Spare2 TEXT,  Category15 TEXT,  Northing NUMERIC,  Commence TEXT,  Lldatum TEXT,  Cease TEXT,  Spare1 TEXT,  Easting NUMERIC,  Owner TEXT,  Station TEXT,  Township TEXT,  Category1 TEXT,  Datecreate TEXT,  Category12 TEXT,  Checkedby TEXT,  Comment TEXT,  Usercreate TEXT,  Qquarter TEXT, PRIMARY KEY (Station))";
  return $sql_statement;
}
...
sub create{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="CREATE TABLE IF NOT EXISTS SITE (, PRIMARY KEY ()";
  return $sql_statement;
}

...
subtype 'PumpreadDatemod', as 'DateTime', where { length($_) <= 8 && $_ =~ m{[1-2]{1}[0,9]{1}\d{6}}}, message{ my $length = length($_);my $value = $_; "Value [$value] must be less than [8] char, not [$length] characters.~"  };
...
subtype 'PumpreadTestdate', as 'DateTime', where { length($_) <= 8 && $_ =~ m{[1-2]{1}[0,9]{1}\d{6}}}, message{ my $length = length($_);my $value = $_; "Value [$value] must be less than [8] char, not [$length] characters.~"  };
subtype 'PumpreadDatecreate', as 'DateTime', where { length($_) <= 8 && $_ =~ m{[1-2]{1}[0,9]{1}\d{6}}}, message{ my $length = length($_);my $value = $_; "Value [$value] must be less than [8] char, not [$length] characters.~"  };
...
sub create{
  ...
  my $sql_statement ="CREATE TABLE IF NOT EXISTS PUMPREAD ( Cumdurat NUMERIC,  Dbver6 NUMERIC,  Ddlvalue NUMERIC,  Pumpdepth NUMERIC,  Usermod TEXT,  Pipe NUMERIC,  Timecreate NUMERIC,  Yield NUMERIC,  Timemod NUMERIC,  Datemod TEXT,  Spare2 TEXT,  Starttime NUMERIC,  Recwl NUMERIC,  Verified NUMERIC,  Spare1 TEXT,  Recdur NUMERIC,  Station TEXT,  Testdate TEXT,  Datecreate TEXT,  Spare3 TEXT,  Hole NUMERIC,  Usercreate TEXT, PRIMARY KEY ()";
...
sub prepare{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="INSERT INTO PUMPREAD VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
  return $sql_statement;
}
...
subtype 'PumpreadUsercreate', as 'Str', where { length($_) <= 8 }, message{ my $length = length($_);my $value = $_; "Value [$value] must be less than [8] char, not [$length] characters.~"  };
 ...
 has 'pumpread_hole'  => ( is => 'rw', isa => 'PumpreadHole' ); 
 has 'pumpread_usercreate'  => ( is => 'rw', isa => 'PumpreadUsercreate' ); 
Field [cumdurat] key value [true]
Field [dbver6] key value [false]
...
sub create{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="CREATE TABLE IF NOT EXISTS PUMPREAD ( Cumdurat NUMERIC,  Dbver6 NUMERIC,  Ddlvalue NUMERIC,  Pumpdepth NUMERIC,  Usermod TEXT,  Pipe NUMERIC,  Timecreate NUMERIC,  Yield NUMERIC,  Timemod NUMERIC,  Datemod TEXT,  Spare2 TEXT,  Starttime NUMERIC,  Recwl NUMERIC,  Verified NUMERIC,  Spare1 TEXT,  Recdur NUMERIC,  Station TEXT,  Testdate TEXT,  Datecreate TEXT,  Spare3 TEXT,  Hole NUMERIC,  Usercreate TEXT, PRIMARY KEY (Cumdurat, Pipe, Starttime, Station, Testdate, Hole))";
  return $sql_statement;
}
...
sub create{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="CREATE TABLE IF NOT EXISTS PUMPREAD (, PRIMARY KEY ()";
  return $sql_statement;
}

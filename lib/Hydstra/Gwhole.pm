...
subtype 'GwholeStartdate', as 'DateTime', where { length($_) <= 8 && $_ =~ m{[1-2]{1}[0,9]{1}\d{6}}}, message{ my $length = length($_);my $value = $_; "Value [$value] must be less than [8] char, not [$length] characters.~"  };
...
subtype 'GwholeDatemod', as 'DateTime', where { length($_) <= 8 && $_ =~ m{[1-2]{1}[0,9]{1}\d{6}}}, message{ my $length = length($_);my $value = $_; "Value [$value] must be less than [8] char, not [$length] characters.~"  };
...
subtype 'GwholeStatrecvd', as 'DateTime', where { length($_) <= 8 && $_ =~ m{[1-2]{1}[0,9]{1}\d{6}}}, message{ my $length = length($_);my $value = $_; "Value [$value] must be less than [8] char, not [$length] characters.~"  };
subtype 'GwholeEnddate', as 'DateTime', where { length($_) <= 8 && $_ =~ m{[1-2]{1}[0,9]{1}\d{6}}}, message{ my $length = length($_);my $value = $_; "Value [$value] must be less than [8] char, not [$length] characters.~"  };
...
subtype 'GwholeDatecreate', as 'DateTime', where { length($_) <= 8 && $_ =~ m{[1-2]{1}[0,9]{1}\d{6}}}, message{ my $length = length($_);my $value = $_; "Value [$value] must be less than [8] char, not [$length] characters.~"  };
...
subtype 'GwholeComment', as 'Str', where { length($_) <= 10 }, message{ my $length = length($_);my $value = $_; "Value [$value] must be less than [10] char, not [$length] characters.~"  };
...
sub create{
  ...
  my $sql_statement ="CREATE TABLE IF NOT EXISTS GWHOLE ( Spare5 TEXT,  Spare4 TEXT,  Usermod TEXT,  Conststat TEXT,  Unlicfst TEXT,  Startdate TEXT,  Yield NUMERIC,  Timemod NUMERIC,  Linkstn TEXT,  Yielddesc TEXT,  Maxdiam NUMERIC,  Datemod TEXT,  Dbver9 NUMERIC,  Constmeth TEXT,  Logavail TEXT,  Partbkfil NUMERIC,  Ownertype TEXT,  Statrecvd TEXT,  Enddate TEXT,  Headcap NUMERIC,  Datumagl NUMERIC,  Parent TEXT,  Hgunumber NUMERIC,  Depthdrill NUMERIC,  Unlicsur TEXT,  Spare3 TEXT,  Consttype TEXT,  Spatvalid NUMERIC,  Caseshoe NUMERIC,  Meascode TEXT,  Headvalve NUMERIC,  Ownername TEXT,  Swl NUMERIC,  Ddlvalue NUMERIC,  Pumpdepth NUMERIC,  Depthcompl NUMERIC,  Timecreate NUMERIC,  Drillic TEXT,  Asstdrillr TEXT,  Boretype TEXT,  Abandnmeth TEXT,  Spare2 TEXT,  Sitemarker NUMERIC,  Obsfreq TEXT,  Contractor TEXT,  Spare1 TEXT,  Salincode TEXT,  Station TEXT,  Airdepth NUMERIC,  Instrument TEXT,  Headopen NUMERIC,  Salinity NUMERIC,  Datecreate TEXT,  Capmethod TEXT,  Hole NUMERIC,  Comment TEXT,  Usercreate TEXT,  Bullcap NUMERIC,  Licvalid NUMERIC, PRIMARY KEY ()";
...
sub prepare{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="INSERT INTO GWHOLE VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
  return $sql_statement;
}
...
Field [spare4]false
Field [usermod]false
Field [conststat]false
Field [unlicfst]false
Field [startdate]false
Field [yield]false
Field [timemod]false
Field [linkstn]false
Field [yielddesc]false
Field [maxdiam]false
Field [datemod]false
Field [dbver9]false
Field [constmeth]false
Field [logavail]false
Field [partbkfil]false
Field [ownertype]false
Field [statrecvd]false
Field [enddate]false
Field [headcap]false
Field [datumagl]false
Field [parent]false
Field [hgunumber]false
Field [depthdrill]false
Field [unlicsur]false
Field [spare3]false
Field [consttype]false
Field [spatvalid]false
Field [caseshoe]false
Field [meascode]false
Field [headvalve]false
Field [ownername]false
Field [swl]false
Field [ddlvalue]false
Field [pumpdepth]false
Field [depthcompl]false
Field [timecreate]false
Field [drillic]false
Field [asstdrillr]false
Field [boretype]false
Field [abandnmeth]false
Field [spare2]false
Field [sitemarker]false
Field [obsfreq]false
Field [contractor]false
Field [spare1]false
Field [salincode]false
Field [station]true
Field [airdepth]false
Field [instrument]false
Field [headopen]false
Field [salinity]false
Field [datecreate]false
Field [capmethod]false
Field [hole]true
Field [comment]false
Field [usercreate]false
Field [bullcap]false
Field [licvalid]false
...
Field [conststat] key value [false]
Field [unlicfst] key value [false]
Field [startdate] key value [false]
Field [yield] key value [false]
Field [timemod] key value [false]
Field [linkstn] key value [false]
Field [yielddesc] key value [false]
Field [maxdiam] key value [false]
Field [datemod] key value [false]
Field [dbver9] key value [false]
Field [constmeth] key value [false]
Field [logavail] key value [false]
Field [partbkfil] key value [false]
Field [ownertype] key value [false]
Field [statrecvd] key value [false]
Field [enddate] key value [false]
Field [headcap] key value [false]
Field [datumagl] key value [false]
Field [parent] key value [false]
Field [hgunumber] key value [false]
Field [depthdrill] key value [false]
Field [unlicsur] key value [false]
Field [spare3] key value [false]
Field [consttype] key value [false]
Field [spatvalid] key value [false]
Field [caseshoe] key value [false]
Field [meascode] key value [false]
Field [headvalve] key value [false]
Field [ownername] key value [false]
Field [swl] key value [false]
Field [ddlvalue] key value [false]
Field [pumpdepth] key value [false]
Field [depthcompl] key value [false]
Field [timecreate] key value [false]
Field [drillic] key value [false]
Field [asstdrillr] key value [false]
Field [boretype] key value [false]
Field [abandnmeth] key value [false]
Field [spare2] key value [false]
Field [sitemarker] key value [false]
Field [obsfreq] key value [false]
Field [contractor] key value [false]
Field [spare1] key value [false]
Field [salincode] key value [false]
Field [station] key value [true]
Field [airdepth] key value [false]
Field [instrument] key value [false]
Field [headopen] key value [false]
Field [salinity] key value [false]
Field [datecreate] key value [false]
Field [capmethod] key value [false]
Field [hole] key value [true]
Field [comment] key value [false]
Field [usercreate] key value [false]
Field [bullcap] key value [false]
Field [licvalid] key value [false]
...
sub create{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="CREATE TABLE IF NOT EXISTS GWHOLE ( Spare5 TEXT,  Spare4 TEXT,  Usermod TEXT,  Conststat TEXT,  Unlicfst TEXT,  Startdate TEXT,  Yield NUMERIC,  Timemod NUMERIC,  Linkstn TEXT,  Yielddesc TEXT,  Maxdiam NUMERIC,  Datemod TEXT,  Dbver9 NUMERIC,  Constmeth TEXT,  Logavail TEXT,  Partbkfil NUMERIC,  Ownertype TEXT,  Statrecvd TEXT,  Enddate TEXT,  Headcap NUMERIC,  Datumagl NUMERIC,  Parent TEXT,  Hgunumber NUMERIC,  Depthdrill NUMERIC,  Unlicsur TEXT,  Spare3 TEXT,  Consttype TEXT,  Spatvalid NUMERIC,  Caseshoe NUMERIC,  Meascode TEXT,  Headvalve NUMERIC,  Ownername TEXT,  Swl NUMERIC,  Ddlvalue NUMERIC,  Pumpdepth NUMERIC,  Depthcompl NUMERIC,  Timecreate NUMERIC,  Drillic TEXT,  Asstdrillr TEXT,  Boretype TEXT,  Abandnmeth TEXT,  Spare2 TEXT,  Sitemarker NUMERIC,  Obsfreq TEXT,  Contractor TEXT,  Spare1 TEXT,  Salincode TEXT,  Station TEXT,  Airdepth NUMERIC,  Instrument TEXT,  Headopen NUMERIC,  Salinity NUMERIC,  Datecreate TEXT,  Capmethod TEXT,  Hole NUMERIC,  Comment TEXT,  Usercreate TEXT,  Bullcap NUMERIC,  Licvalid NUMERIC, PRIMARY KEY (Station, Hole))";
  return $sql_statement;
}
...
sub create{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="CREATE TABLE IF NOT EXISTS GWHOLE (, PRIMARY KEY ()";
  return $sql_statement;
}

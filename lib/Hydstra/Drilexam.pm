...
sub create{
  ...
  my $sql_statement ="CREATE TABLE IF NOT EXISTS DRILEXAM ( Usermod TEXT,  Timecreate NUMERIC,  Drillic TEXT,  Landowner TEXT,  Town TEXT,  Yield NUMERIC,  Timemod NUMERIC,  Boretype TEXT,  State TEXT,  Datemod TEXT,  Addr2 TEXT,  Dbver3 NUMERIC,  Spare2 TEXT,  Addr1 TEXT,  Postcode TEXT,  Spare1 TEXT,  Borelic TEXT,  Diameter NUMERIC,  Datecreate TEXT,  Spare3 TEXT,  Usercreate TEXT,  Addr3 TEXT, PRIMARY KEY ()";
...
sub prepare{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="INSERT INTO DRILEXAM VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
  return $sql_statement;
}
...
Field [landowner] key value [false]
...
sub create{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="CREATE TABLE IF NOT EXISTS DRILEXAM ( Usermod TEXT,  Timecreate NUMERIC,  Drillic TEXT,  Landowner TEXT,  Town TEXT,  Yield NUMERIC,  Timemod NUMERIC,  Boretype TEXT,  State TEXT,  Datemod TEXT,  Addr2 TEXT,  Dbver3 NUMERIC,  Spare2 TEXT,  Addr1 TEXT,  Postcode TEXT,  Spare1 TEXT,  Borelic TEXT,  Diameter NUMERIC,  Datecreate TEXT,  Spare3 TEXT,  Usercreate TEXT,  Addr3 TEXT, PRIMARY KEY (Drillic, Borelic))";
  return $sql_statement;
}
...
sub create{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="CREATE TABLE IF NOT EXISTS DRILEXAM (, PRIMARY KEY ()";
  return $sql_statement;
}

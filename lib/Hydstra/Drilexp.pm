...
sub create{
  ...
  my $sql_statement ="CREATE TABLE IF NOT EXISTS DRILEXP ( Numassist NUMERIC,  Usermod TEXT,  Drillic TEXT,  Timecreate NUMERIC,  Numbores NUMERIC,  Datecreate TEXT,  Timemod NUMERIC,  Datemod TEXT,  Spare3 TEXT,  State TEXT,  Dbver3 NUMERIC,  Spare2 TEXT,  Usercreate TEXT,  Class TEXT,  Spare1 TEXT, PRIMARY KEY ()";
...
subtype 'DrilexpSpare1', as 'Str', where { length($_) <= 30 }, message{ my $length = length($_);my $value = $_; "Value [$value] must be less than [30] char, not [$length] characters.~"  };
 ...
 has 'drilexp_class'  => ( is => 'rw', isa => 'DrilexpClass' ); 
 has 'drilexp_spare1'  => ( is => 'rw', isa => 'DrilexpSpare1' ); 
Field [numassist]false
Field [usermod]false
Field [drillic]true
Field [timecreate]false
Field [numbores]false
...
sub create{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="CREATE TABLE IF NOT EXISTS DRILEXP ( Numassist NUMERIC,  Usermod TEXT,  Drillic TEXT,  Timecreate NUMERIC,  Numbores NUMERIC,  Datecreate TEXT,  Timemod NUMERIC,  Datemod TEXT,  Spare3 TEXT,  State TEXT,  Dbver3 NUMERIC,  Spare2 TEXT,  Usercreate TEXT,  Class TEXT,  Spare1 TEXT, PRIMARY KEY (Drillic, State, Class))";
  return $sql_statement;
}
...
sub create{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="CREATE TABLE IF NOT EXISTS DRILEXP (, PRIMARY KEY ()";
  return $sql_statement;
}
...
sub create{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="CREATE TABLE IF NOT EXISTS DRILEXP ( Placeholder ,  Drillic TEXT,  Class TEXT,  State TEXT,  Numbores NUMERIC,  Numassist NUMERIC,  Spare1 TEXT,  Spare2 TEXT,  Spare3 TEXT,  Dbver3 NUMERIC,  Datecreate TEXT,  Timecreate NUMERIC,  Usercreate TEXT,  Datemod TEXT,  Timemod NUMERIC,  Usermod TEXT, PRIMARY KEY (Drillic, Class, State))";
  return $sql_statement;
}

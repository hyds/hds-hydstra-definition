...
sub create{
  ...
  my $sql_statement ="CREATE TABLE IF NOT EXISTS GWPURP ( Spare5 TEXT,  Spare4 TEXT,  Usermod TEXT,  Status TEXT,  Timecreate NUMERIC,  Date TEXT,  Purpose TEXT,  Dbver5 NUMERIC,  Timemod NUMERIC,  Datemod TEXT,  Spare2 TEXT,  Spare1 TEXT,  Station TEXT,  Datecreate TEXT,  Spare3 TEXT,  Hole NUMERIC,  Usercreate TEXT,  Infosource TEXT, PRIMARY KEY ()";
...
sub prepare{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="INSERT INTO GWPURP VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
  return $sql_statement;
}
...
Field [infosource] key value [false]
...
sub create{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="CREATE TABLE IF NOT EXISTS GWPURP ( Spare5 TEXT,  Spare4 TEXT,  Usermod TEXT,  Status TEXT,  Timecreate NUMERIC,  Date TEXT,  Purpose TEXT,  Dbver5 NUMERIC,  Timemod NUMERIC,  Datemod TEXT,  Spare2 TEXT,  Spare1 TEXT,  Station TEXT,  Datecreate TEXT,  Spare3 TEXT,  Hole NUMERIC,  Usercreate TEXT,  Infosource TEXT, PRIMARY KEY (Date, Purpose, Station, Hole))";
  return $sql_statement;
}
...
sub create{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="CREATE TABLE IF NOT EXISTS GWPURP (, PRIMARY KEY ()";
  return $sql_statement;
}

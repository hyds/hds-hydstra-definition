...
sub create{
  ...
  my $sql_statement ="CREATE TABLE IF NOT EXISTS BENCH ( Elevacc TEXT,  Bdate TEXT,  Usermod TEXT,  Timecreate NUMERIC,  Rlgd NUMERIC,  Elev NUMERIC,  Timemod NUMERIC,  Datemod TEXT,  Dbver23 NUMERIC,  Latitude NUMERIC,  Desc TEXT,  Text TEXT,  Bench TEXT,  Method TEXT,  Lldatum TEXT,  Enteredby TEXT,  Station TEXT,  Longitude NUMERIC,  Benchtyp TEXT,  Datecreate TEXT,  Checkedby TEXT,  Usercreate TEXT,  Datum TEXT, PRIMARY KEY ()";
...
Field [desc] key value [false]
Field [text] key value [false]
Field [bench] key value [true]
...
Field [benchtyp] key value [false]
...
sub create{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="CREATE TABLE IF NOT EXISTS BENCH ( Elevacc TEXT,  Bdate TEXT,  Usermod TEXT,  Timecreate NUMERIC,  Rlgd NUMERIC,  Elev NUMERIC,  Timemod NUMERIC,  Datemod TEXT,  Dbver23 NUMERIC,  Latitude NUMERIC,  Desc TEXT,  Text TEXT,  Bench TEXT,  Method TEXT,  Lldatum TEXT,  Enteredby TEXT,  Station TEXT,  Longitude NUMERIC,  Benchtyp TEXT,  Datecreate TEXT,  Checkedby TEXT,  Usercreate TEXT,  Datum TEXT, PRIMARY KEY (Bdate, Bench, Station))";
  return $sql_statement;
}
...
sub create{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="CREATE TABLE IF NOT EXISTS BENCH (, PRIMARY KEY ()";
  return $sql_statement;
}

...
sub create{
  ...
  my $sql_statement ="CREATE TABLE IF NOT EXISTS STATION ( Ctf NUMERIC,  Telemetry NUMERIC,  Usermod TEXT,  Timecreate NUMERIC,  Timemod NUMERIC,  Datemod TEXT,  Maxgaug NUMERIC,  Order NUMERIC,  Gaugfacil TEXT,  Downst NUMERIC,  Enteredby TEXT,  Qmin NUMERIC,  Catcharea NUMERIC,  Control TEXT,  Contcode TEXT,  Station TEXT,  Tmin NUMERIC,  Dbver21 NUMERIC,  Maxgdate TEXT,  Datecreate TEXT,  Phone TEXT,  Streamdist NUMERIC,  Checkedby TEXT,  Gauge NUMERIC,  Usercreate TEXT,  Spillway NUMERIC,  Datum TEXT,  Hut NUMERIC,  Bedslope NUMERIC, PRIMARY KEY ()";
...
Field [maxgaug]false
Field [order]false
Field [gaugfacil]false
Field [downst]false
Field [enteredby]false
Field [qmin]false
Field [catcharea]false
Field [control]false
Field [contcode]false
Field [station]true
Field [tmin]false
Field [dbver21]false
Field [maxgdate]false
Field [datecreate]false
Field [phone]false
Field [streamdist]false
Field [checkedby]false
Field [gauge]false
Field [usercreate]false
Field [spillway]false
Field [datum]false
Field [hut]false
Field [bedslope]false
...
Field [telemetry] key value [false]
Field [usermod] key value [false]
Field [timecreate] key value [false]
Field [timemod] key value [false]
Field [datemod] key value [false]
Field [maxgaug] key value [false]
Field [order] key value [false]
Field [gaugfacil] key value [false]
Field [downst] key value [false]
Field [enteredby] key value [false]
Field [qmin] key value [false]
Field [catcharea] key value [false]
Field [control] key value [false]
Field [contcode] key value [false]
Field [station] key value [true]
Field [tmin] key value [false]
Field [dbver21] key value [false]
Field [maxgdate] key value [false]
Field [datecreate] key value [false]
Field [phone] key value [false]
Field [streamdist] key value [false]
Field [checkedby] key value [false]
Field [gauge] key value [false]
Field [usercreate] key value [false]
Field [spillway] key value [false]
Field [datum] key value [false]
Field [hut] key value [false]
Field [bedslope] key value [false]
...
sub create{
  my $uctable = UC_TABLE_NAME;
  my $sql_statement ="CREATE TABLE IF NOT EXISTS STATION (, PRIMARY KEY ()";
  return $sql_statement;
}
